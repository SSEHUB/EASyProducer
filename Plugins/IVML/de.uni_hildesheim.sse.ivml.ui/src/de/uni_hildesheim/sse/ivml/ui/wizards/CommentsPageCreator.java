...
/**
 * Creates the contents of the {@link CommentsFiletypeWizard}.
 * @author El-Sharkawy
 *
 */
class CommentsPageCreator implements IWizardPageFactory {

    @Override
    public AbstractFiletypeWizardPage createPage(ISelection selection) {
        return new CommentsFiletypeWizardPage(selection);
    }
