		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTypedefCompoundAccess().getAlternatives_4(), "rule__TypedefCompound__Alternatives_4");
					...
					put(grammarAccess.getTypedefCompoundAccess().getGroup_2(), "rule__TypedefCompound__Group_2__0");
					...
					put(grammarAccess.getTypedefConstraintAccess().getGroup_3(), "rule__TypedefConstraint__Group_3__0");
					...
					put(grammarAccess.getAttributeToAccess().getGroup_5(), "rule__AttributeTo__Group_5__0");
					...
					put(grammarAccess.getFreezeButListAccess().getGroup(), "rule__FreezeButList__Group__0");
					put(grammarAccess.getFreezeButListAccess().getGroup_2(), "rule__FreezeButList__Group_2__0");
					put(grammarAccess.getFreezeButExpressionAccess().getGroup(), "rule__FreezeButExpression__Group__0");
					...
					put(grammarAccess.getImportStmtAccess().getGroup_3_3(), "rule__ImportStmt__Group_3_3__0");
					...
					put(grammarAccess.getConflictStmtAccess().getGroup_2_3(), "rule__ConflictStmt__Group_2_3__0");
					...
					put(grammarAccess.getTypedefCompoundAccess().getNameAssignment_1(), "rule__TypedefCompound__NameAssignment_1");
					put(grammarAccess.getTypedefCompoundAccess().getSuperAssignment_2_1(), "rule__TypedefCompound__SuperAssignment_2_1");
					put(grammarAccess.getTypedefCompoundAccess().getElementsAssignment_4_0(), "rule__TypedefCompound__ElementsAssignment_4_0");
					put(grammarAccess.getTypedefCompoundAccess().getElementsAssignment_4_1(), "rule__TypedefCompound__ElementsAssignment_4_1");
					put(grammarAccess.getTypedefCompoundAccess().getElementsAssignment_4_2(), "rule__TypedefCompound__ElementsAssignment_4_2");
					...
					put(grammarAccess.getTypedefConstraintAccess().getExpressionsAssignment_3_1(), "rule__TypedefConstraint__ExpressionsAssignment_3_1");
					...
					put(grammarAccess.getDslContextAccess().getStopAssignment_2(), "rule__DslContext__StopAssignment_2");
					put(grammarAccess.getDslContextAccess().getEscapeAssignment_4(), "rule__DslContext__EscapeAssignment_4");
					put(grammarAccess.getDslContextAccess().getCommandAssignment_6(), "rule__DslContext__CommandAssignment_6");
					put(grammarAccess.getDslContextAccess().getDslAssignment_8(), "rule__DslContext__DslAssignment_8");
					put(grammarAccess.getAttributeToAccess().getAttributeTypeAssignment_1(), "rule__AttributeTo__AttributeTypeAssignment_1");
					put(grammarAccess.getAttributeToAccess().getAttributeDeclAssignment_2(), "rule__AttributeTo__AttributeDeclAssignment_2");
					put(grammarAccess.getAttributeToAccess().getNamesAssignment_4(), "rule__AttributeTo__NamesAssignment_4");
					put(grammarAccess.getAttributeToAccess().getNamesAssignment_5_1(), "rule__AttributeTo__NamesAssignment_5_1");
					put(grammarAccess.getFreezeAccess().getNamesAssignment_2(), "rule__Freeze__NamesAssignment_2");
					put(grammarAccess.getFreezeAccess().getButAssignment_4_1(), "rule__Freeze__ButAssignment_4_1");
					...
					put(grammarAccess.getFreezeButListAccess().getListAssignment_1(), "rule__FreezeButList__ListAssignment_1");
					put(grammarAccess.getFreezeButListAccess().getListAssignment_2_1(), "rule__FreezeButList__ListAssignment_2_1");
					put(grammarAccess.getFreezeButExpressionAccess().getNameAssignment_0(), "rule__FreezeButExpression__NameAssignment_0");
					put(grammarAccess.getFreezeButExpressionAccess().getAccessAssignment_1(), "rule__FreezeButExpression__AccessAssignment_1");
					put(grammarAccess.getFreezeButExpressionAccess().getWildcardAssignment_2(), "rule__FreezeButExpression__WildcardAssignment_2");
					...
					put(grammarAccess.getImportStmtAccess().getVersionsAssignment_3_2(), "rule__ImportStmt__VersionsAssignment_3_2");
					put(grammarAccess.getImportStmtAccess().getVersionsAssignment_3_3_1(), "rule__ImportStmt__VersionsAssignment_3_3_1");
					put(grammarAccess.getConflictStmtAccess().getNameAssignment_1(), "rule__ConflictStmt__NameAssignment_1");
					put(grammarAccess.getConflictStmtAccess().getConflictsAssignment_2_2(), "rule__ConflictStmt__ConflictsAssignment_2_2");
					put(grammarAccess.getConflictStmtAccess().getConflictsAssignment_2_3_1(), "rule__ConflictStmt__ConflictsAssignment_2_3_1");
					put(grammarAccess.getVersionedIdAccess().getNameAssignment_0(), "rule__VersionedId__NameAssignment_0");
					put(grammarAccess.getVersionedIdAccess().getOpAssignment_2(), "rule__VersionedId__OpAssignment_2");
					put(grammarAccess.getVersionedIdAccess().getVersionAssignment_3(), "rule__VersionedId__VersionAssignment_3");
					...
					put(grammarAccess.getExpressionAccess().getDslAssignment_3(), "rule__Expression__DslAssignment_3");
					...
					put(grammarAccess.getPrimaryExpressionAccess().getRefNameAssignment_0_3_2(), "rule__PrimaryExpression__RefNameAssignment_0_3_2");
