...
public class IvmlParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, IvmlGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getFreezeStatementAccess().getAlternatives_0(), "rule__FreezeStatement__Alternatives_0");
			...
			builder.put(grammarAccess.getFreezeAccess().getGroup_4(), "rule__Freeze__Group_4__0");
			builder.put(grammarAccess.getFreezeStatementAccess().getGroup(), "rule__FreezeStatement__Group__0");
			builder.put(grammarAccess.getFreezeStatementAccess().getGroup_0_1(), "rule__FreezeStatement__Group_0_1__0");
			...
			builder.put(grammarAccess.getFreezeAccess().getNamesAssignment_2(), "rule__Freeze__NamesAssignment_2");
			builder.put(grammarAccess.getFreezeAccess().getIdAssignment_4_2(), "rule__Freeze__IdAssignment_4_2");
			builder.put(grammarAccess.getFreezeAccess().getExAssignment_4_4(), "rule__Freeze__ExAssignment_4_4");
			builder.put(grammarAccess.getFreezeStatementAccess().getDotAssignment_0_0(), "rule__FreezeStatement__DotAssignment_0_0");
			builder.put(grammarAccess.getFreezeStatementAccess().getNameAssignment_0_1_0(), "rule__FreezeStatement__NameAssignment_0_1_0");
			builder.put(grammarAccess.getFreezeStatementAccess().getAccessAssignment_0_1_1(), "rule__FreezeStatement__AccessAssignment_0_1_1");
