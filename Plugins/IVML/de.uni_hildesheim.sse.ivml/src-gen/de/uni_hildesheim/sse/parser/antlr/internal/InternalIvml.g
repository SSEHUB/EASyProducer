...
entryRuleDslContext returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getDslContextRule()); }
	 iv_ruleDslContext=ruleDslContext 
	 { $current=$iv_ruleDslContext.current; } 
	 EOF 
;

// Rule DslContext
ruleDslContext returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='DSL' 
...
entryRuleAttributeTo returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAttributeToRule()); }
	 iv_ruleAttributeTo=ruleAttributeTo 
	 { $current=$iv_ruleAttributeTo.current; } 
	 EOF 
;

// Rule AttributeTo
ruleAttributeTo returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='attribute' 
...
entryRuleFreezeButList returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getFreezeButListRule()); }
	 iv_ruleFreezeButList=ruleFreezeButList 
	 { $current=$iv_ruleFreezeButList.current; } 
	 EOF 
;

// Rule FreezeButList
ruleFreezeButList returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='(' 
...
entryRuleFreezeButExpression returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getFreezeButExpressionRule()); }
	 iv_ruleFreezeButExpression=ruleFreezeButExpression 
	 { $current=$iv_ruleFreezeButExpression.current; } 
	 EOF 
;

// Rule FreezeButExpression
ruleFreezeButExpression returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleVersionedId returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getVersionedIdRule()); }
	 iv_ruleVersionedId=ruleVersionedId 
	 { $current=$iv_ruleVersionedId.current; } 
	 EOF 
;

// Rule VersionedId
ruleVersionedId returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleVersionOperator returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getVersionOperatorRule()); } 
	 iv_ruleVersionOperator=ruleVersionOperator 
	 { $current=$iv_ruleVersionOperator.current.getText(); }  
	 EOF 
;

// Rule VersionOperator
ruleVersionOperator returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
