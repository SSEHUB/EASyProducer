 ...
 *
 */
public abstract class AbstractQualiMasterTest extends net.ssehub.easy.sseReasoner.AbstractTest {
    ...
    public final void reasoningTest(int expectedFailedConstraints) {
        ...
        net.ssehub.easy.sseReasoner.AllTests.resultHandler(expectedFailedConstraints, qm);
    }    
