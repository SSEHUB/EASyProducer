...
import net.ssehub.easy.sseReasoner.Engine;
...
@RunWith(Suite.class)
@SuiteClasses({
    net.ssehub.easy.sseReasoner.capabilities.AllTests.class,
    // Skip: performance in automatic testing 
    net.ssehub.easy.sseReasoner.qm.AllTests.class,
    net.ssehub.easy.sseReasoner.reasoner.AllTests.class
    })
