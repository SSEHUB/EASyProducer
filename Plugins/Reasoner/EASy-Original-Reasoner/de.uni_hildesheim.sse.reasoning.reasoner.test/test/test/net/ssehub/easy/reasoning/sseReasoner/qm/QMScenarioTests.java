...
public class QMScenarioTests extends AbstractTest<Project> {
    ...
    public void reasoningTest(String ivmlFile, int expectedFailedConstraints) {
        ...
        test.net.ssehub.easy.reasoning.sseReasoner.AllTests.resultHandler(expectedFailedConstraints, project);
    }   
    ...
    public void reasoningTest(String p0, String p1, int expectedFailedConstraints) {
        ...
        test.net.ssehub.easy.reasoning.sseReasoner.AllTests.resultHandler(expectedFailedConstraints, projectP1);
    }
    ...
    public void reasoningTest(String p0, String p1, String p2, int expectedFailedConstraints) {
        ...
        test.net.ssehub.easy.reasoning.sseReasoner.AllTests.resultHandler(expectedFailedConstraints, projectP2);
    }
