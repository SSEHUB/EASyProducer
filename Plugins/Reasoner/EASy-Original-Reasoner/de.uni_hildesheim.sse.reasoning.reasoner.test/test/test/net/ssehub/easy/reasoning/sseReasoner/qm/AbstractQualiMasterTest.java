 ...
 *
 */
public abstract class AbstractQualiMasterTest extends test.net.ssehub.easy.reasoning.sseReasoner.AbstractTest {
    ...
    public final void reasoningTest(int expectedFailedConstraints) {
        ...
        test.net.ssehub.easy.reasoning.sseReasoner.AllTests.resultHandler(expectedFailedConstraints, qm);
    }    
