...
import net.ssehub.easy.reasoning.drools2.model.datatypes.ReasonerTypeFactory;
import net.ssehub.easy.reasoning.drools2.model.variables.ConstraintVariable;
import net.ssehub.easy.reasoning.drools2.model.variables.ReasonerVariable;
import net.ssehub.easy.reasoning.drools2.model.variables.ReasonerVariableFactory;
 ...
 * {@link  net.ssehub.easy.reasoning.core.reasoner.IReasoner}.
 * @author El-Sharkawy
 *
 */
public class ReasonerModel implements IConstraintContainer, Iterable<ReasonerVariable>, IVariableContainer {
    ...
    private static final EASyLogger LOGGER
        = EASyLoggerFactory.INSTANCE.getLogger(ReasonerModel.class, "Drools2 ReasonerModel");
...
//        Statistic.addTimestamp(reasoningID, System.currentTimeMillis());
     ...
     * @param project The project, where an {@link net.ssehub.easy.reasoning.core.reasoner.IReasoner
