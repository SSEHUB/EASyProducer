...
/**
 * Handler for translating {@link de.uni_hildesheim.sse.model.varModel.datatypes.OclKeyWords#PLUS} operations.
 * @author Sizonenko
 *
 */
class AdditionHandler extends TranslationFragment {
