...
import net.ssehub.easy.reasonerCore.model.IVariableContainer;
import net.ssehub.easy.reasonerCore.model.ReasonerModel;
import net.ssehub.easy.reasonerCore.model.ReasoningState;
...
public class CompoundVariable extends CustomVariable implements IVariableContainer {
     ...
     *     {@link net.ssehub.easy.reasonerCore.model.ReasonerModel}.
     * @param model the {@link ReasonerModel}, where this variable should be added to
     *     (needed for {@link net.ssehub.easy.reasonerCore.model.datatypes.ReasonerDatatype} resolution).
