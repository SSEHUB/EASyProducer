...
import net.ssehub.easy.reasoning.core.model.IVariableContainer;
...
public class CompoundVariable extends CustomVariable implements IVariableContainer {
     ...
     *     (needed for {@link net.ssehub.easy.reasoning.core.model.datatypes.ReasonerDatatype} resolution).
