...
import net.ssehub.easy.reasonerCore.model.datatypes.ReasonerTypeFactory;
import net.ssehub.easy.reasonerCore.model.variables.ConstraintVariable;
import net.ssehub.easy.reasonerCore.model.variables.ReasonerVariable;
import net.ssehub.easy.reasonerCore.model.variables.ReasonerVariableFactory;
 ...
 * {@link  net.ssehub.easy.reasonerCore.reasoner.IReasoner}.
 * @author El-Sharkawy
 *
 */
...
//        Statistic.addTimestamp(reasoningID, System.currentTimeMillis());
     ...
     * @param project The project, where an {@link net.ssehub.easy.reasonerCore.reasoner.IReasoner
