...
/**
 * Implements a constraint with attached object (fixed and {@link Constraint.Type#USUAL} type).
 * 
...
public class AttachedConstraint extends Constraint {
     ...
     * @param type the type this constraint is attached to
     ...
     */
    public AttachedConstraint(ConstraintSyntaxTree consSyntax, IDatatype type, IModelElement parent) 
