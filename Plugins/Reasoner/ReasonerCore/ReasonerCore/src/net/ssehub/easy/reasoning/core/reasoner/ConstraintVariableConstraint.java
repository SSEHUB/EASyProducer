...
/**
 * Reasoner specific constraint type indicating a {@link Type#CONSTRAINT}. This shall avoid requiring an attribute for 
 * this purpose for all constraints and using it just for temporary reasoning ones.
 * 
 * @author Holger Eichelberger
 */
public class ConstraintVariableConstraint extends Constraint {
     ...
     */
    public ConstraintVariableConstraint(ConstraintSyntaxTree consSyntax, IModelElement parent) 
