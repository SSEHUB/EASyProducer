...
import net.ssehub.easy.reasonerCore.model.variables.BooleanVariable;
import net.ssehub.easy.reasonerCore.model.variables.CompoundVariable;
import net.ssehub.easy.reasonerCore.model.variables.EnumVariable;
import net.ssehub.easy.reasonerCore.model.variables.IntVariable;
import net.ssehub.easy.reasonerCore.model.variables.RealVariable;
import net.ssehub.easy.reasonerCore.model.variables.ReasonerVariable;
import net.ssehub.easy.reasonerCore.model.variables.ReferenceVariable;
import net.ssehub.easy.reasonerCore.model.variables.SequenceVariable;
import net.ssehub.easy.reasonerCore.model.variables.SetVariable;
import net.ssehub.easy.reasonerCore.model.variables.StringVariable;
