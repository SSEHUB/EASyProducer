...
public class PersistentProject {
    ...
    public PersistentProject(Project project, File location, File configFolder, Model... models) {
        this(location);
        this.project = new ProjectContainer(project, configFolder);
    ...
    private void createModels() {
        models = new Model[]{new Model(ModelType.ROOT), new Model(ModelType.PREDECESSORS),
            new Model(ModelType.SUCCESSORS), new Model(ModelType.INSTANTIATORS), new Model(ModelType.REASONERS),
            new Model(ModelType.COPY)};
    }
     ...
     * @param configFolder The folder storing the loaded project.
     */
    public void setProject(Project project, File configFolder) {
        this.project = new ProjectContainer(project, configFolder);
    }
     ...
     * @param configFolder The folder storing the loaded project.
     */
    public void setScript(Script mainBuildScript, File configFolder) {
        this.mainBuildScript = new ScriptContainer(mainBuildScript, configFolder);
    }
