 ...
 * m, "dataField": m, "nested": m}, "$period": p, "$repeats": r}}. Depending on your data type definitions in
 * the model, individual fields may be mandatory (indicated by <i>m</i>), optional (indicated by <i>o</i>) or nested
...
public class MyAnonymizerExampleTest extends SpringAsyncServiceBase {
    ...
    */
    public static class DataUnit extends BaseDataUnit {
        ...
        private MyConnPltfInImpl myConnPltfIn;
        ...
        */
        public MyConnPltfInImpl getMyConnPltfIn() {
            return myConnPltfIn;
        }
        ...
        */
        public void setMyConnPltfIn(MyConnPltfInImpl myConnPltfIn) {
    ...
    */
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(TestChannelBinderConfiguration.
            ...
            consumer.addHandler(MyConnPltfInImpl.class, d -> {
