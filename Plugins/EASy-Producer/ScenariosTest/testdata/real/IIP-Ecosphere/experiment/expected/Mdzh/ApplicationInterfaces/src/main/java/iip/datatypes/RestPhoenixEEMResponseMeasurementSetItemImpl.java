...
/**
 * Implementation of the application data type RestPhoenixEEMResponseMeasurementSetItem.
 * Generated by: EASy-Producer.
 */
@ConfiguredName("RestPhoenixEEMResponseMeasurementSetItem")
public class RestPhoenixEEMResponseMeasurementSetItemImpl implements RestPhoenixEEMResponseMeasurementSetItem {
     ...
     */
    public RestPhoenixEEMResponseMeasurementSetItemImpl() {
    }
     ...
     */
    public RestPhoenixEEMResponseMeasurementSetItemImpl(RestPhoenixEEMResponseMeasurementSetItem from) {
    ...
    public int hashCode() {
        ...
        hc += getUnit() != null ? getUnit().hashCode() : 0;
    ...
    public boolean equals(Object other) {
        boolean eq;
        if (other instanceof RestPhoenixEEMResponseMeasurementSetItem) {
            RestPhoenixEEMResponseMeasurementSetItem oth = (RestPhoenixEEMResponseMeasurementSetItem) other;
            eq = true;
            ...
            eq &= getUnit() != null ? getUnit().equals(oth.getUnit()) : true;
