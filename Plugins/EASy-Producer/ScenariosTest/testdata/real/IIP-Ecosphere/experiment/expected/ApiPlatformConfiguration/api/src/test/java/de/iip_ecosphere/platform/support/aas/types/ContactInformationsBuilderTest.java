...
public class ContactInformationsBuilderTest extends AbstractAasExample {
    ...
    */
    ...
    /**
    * Returns the test submodel builder, e.g., for ranges.
    *
    * @return the test submodel builder, e.g., for ranges
    */
    protected static SubmodelBuilder getTestSmBuilder() {
    ...
    */
    ...
    public void testEnums() {
        assertEnum(RoleOfContactPerson.values(), v -> v.getValue() != null && v.getValueId() >= 0 && v.getSemanticId() 
            != null);
        assertEnum(TypeOfEmailAddress.values(), v -> v.getValue() != null && v.getValueId() >= 0 && v.getSemanticId() 
            != null);
        assertEnum(TypeOfFaxNumber.values(), v -> v.getValue() != null && v.getValueId() >= 0 && v.getSemanticId() 
            != null);
        assertEnum(TypeOfTelephone.values(), v -> v.getValue() != null && v.getValueId() >= 0 && v.getSemanticId() 
            != null);
    }
