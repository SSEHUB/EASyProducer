...
public class MyModbusSentronConnExampleTest {
    ...
    */
    public static class DataUnit extends DataMapper.BaseDataUnit {
        ...
        /**
        * Returns modbusSiemensRwSentron.
        *
        * @return modbusSiemensRwSentron, may be <b>null</b>
        */
        ...
        /**
        * Changes modbusSiemensRwSentron. [required by Jackson]
        *
    ...
    */
    protected void testConnector(ConnectorParameter params, ReceptionCallback<ModbusSiemensSentron> callback) throws IOException {
        ...
        de.iip_ecosphere.platform.connectors.modbustcpipv1.ModbusTcpIpConnector<ModbusSiemensSentron, ModbusSiemensRwSentron> conn = 
            new de.iip_ecosphere.platform.connectors.modbustcpipv1.ModbusTcpIpConnector<>(MyModbusSentronConnExample.createConnectorAdapter());
        conn.connect(params);
    ...
    */
    ...
    /**
    * Creates/returns a predicate asserting that the received data of type ModbusSiemensSentron
