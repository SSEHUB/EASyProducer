 ...
 * in the configuration model. The structure for this service is: {@code {"kRec13": {"intField": m,
...
"spring.cloud.stream.source=data_createKRec13_SimpleKodexSource_KodexMeshApp;data_processKRec13Anon_Pseudonymizer_Kode"
+ "xMeshApp",
    ...
    */
    public static class DataUnit extends BaseDataUnit {
        ...
        */
        ...
        /**
        * Changes the value of kRec13. [required by Jackson]
        *
