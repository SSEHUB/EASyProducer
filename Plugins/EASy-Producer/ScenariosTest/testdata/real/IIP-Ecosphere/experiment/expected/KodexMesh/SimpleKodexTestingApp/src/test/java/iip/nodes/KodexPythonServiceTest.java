...
* property "iip.test.dataFile", "../../src/test/resources/testData-KodexPythonService.json", the default resource "testData-KodexPythonService.json" 
...
@TestPropertySource(properties = {
    "spring.cloud.function.definition=transformKRec13AnonKRec13Anon_KodexPythonService",
        "spring.cloud.stream.source=data_processKRec13Anon_Pseudonymizer_KodexMeshApp;data_transformKRec13AnonKRec13Anon_KodexPythonService_KodexMeshApp",
...
public class KodexPythonServiceTest extends SpringAsyncServiceBase {
    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(KRec13AnonImpl.class, d -> {
                                        Message<KRec13AnonImpl> msg = MessageBuilder.withPayload(d).build();
                                        source.send(msg);
            ...
            createReceptionCallback("data_KodexPythonService_KRec13Anon_KodexMeshApp", d -> {
                ...
                printReceivedData(d);
                Assert.assertTrue(predKRec13Anon.test(d));
            }, KRec13Anon.class);
    ...
    * "../../src/test/resources/testData-KodexPythonService.json" or the default resource "testData-KodexPythonService.json".
    *
    ...
    */
    public void testService() throws IOException {
        InputStream in;
        try {
            String fileName = System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-KodexPythonService.json");
    ...
    */
    ...
    public void testKodexPythonServiceService() throws IOException {
        ...
        Service svc = iip.Starter.getMappedService("KodexPythonService");
        if (null != svc) {
            try {
                LoggerFactory.getLogger(getClass()).info("Service autostop (test): KodexPythonService");
                svc.setState(ServiceState.STOPPING);
            } catch (ExecutionException e) {
                LoggerFactory.getLogger(getClass()).error("Stopping service KodexPythonService: {}", e.getMessage());
            }
        }
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(KodexPythonServiceTest.class).info("Service artifact {} not found in {}", "SimpleKodexTestingApp-0.1.0-SNAPSHOT-bin.jar", "..");
        }
