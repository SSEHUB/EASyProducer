    ...
    public static class ContactInformation extends DelegatingSubmodelElementCollection {
        ...
        */
        public Phone getPhone() {
            var tmp = super.getSubmodelElementCollection("Phone");
            return null ==  tmp ? null : new Phone(tmp);
        }
        ...
        */
        public Fax getFax() {
            var tmp = super.getSubmodelElementCollection("Fax");
            return null == tmp ? null : new Fax(tmp);
        }
        ...
        */
        public Email getEmail() {
            var tmp = super.getSubmodelElementCollection("Email");
            return null == tmp ? null : new Email(tmp);
        }
