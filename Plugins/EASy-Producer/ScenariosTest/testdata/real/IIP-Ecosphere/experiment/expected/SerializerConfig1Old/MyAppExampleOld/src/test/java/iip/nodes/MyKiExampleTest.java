...
/**
 * Implements tests for "MyKiExample". The generated class is meant to be re-usable and extensible, e.g., regarding the
 ...
 * "../../src/test/resources/testData-myKi.json", the default resource "testData-myKi.json" or
 ...
 * for this service is: {@code {"rec1": {"intField": m, "stringField": m}, "$period": p, "$repeats": r}}.
...
public class MyKiExampleTest extends SpringAsyncServiceBase {
    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(TestChannelBinderConfiguration.
            ...
            consumer.addHandler(Rec1.class, d -> {
                Message<Rec1> msg = MessageBuilder.withPayload(d)
                    .build();
                source.send(msg);
    ...
    */
    ...
    public void testMyKiService() throws IOException {
        ...
        Service svc = Starter.getMappedService("myKi");
        if (null != svc) {
            try {
                LoggerFactory.getLogger(getClass())
                    .info("Service autostop (test): myKi");
                svc.setState(ServiceState.STOPPING);
            } catch (ExecutionException e) {
                LoggerFactory.getLogger(getClass())
                    .error("Stopping service myKi: {}", e.getMessage());
            }
        }
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(MyKiExampleTest.class)
