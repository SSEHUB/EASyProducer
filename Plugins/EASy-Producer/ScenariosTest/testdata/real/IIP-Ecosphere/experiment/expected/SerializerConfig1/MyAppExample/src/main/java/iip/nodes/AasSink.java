    ...
    */
    ...
    public void initService() {
        if (null == activated || "".equals(activated) || "true".equals(activated)) {
            ...
            createReceptionCallback("data_myRtsa_RtsaTestOutput_myApp" + appInstId, receiveRtsaTestOutput_aasSink(), RtsaTestOutput.class, "receiveRtsaTestOutput_aasSink-in-0");
        }
    }
