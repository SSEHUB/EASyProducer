...
public class MyReceiver extends SpringAsyncServiceBase {
     ...
     */
    public MyReceiver() {
        service = AbstractService.createInstance("MyReceiverImpl", 
            MyReceiverService.class, 
            "MyReceiver", 
            "deployment.yml");
    ...
    */
    ...
    public void initService() {
        if (null == activated || "".equals(activated) || "true".equals(activated)) {
            LoggerFactory.getLogger(getClass()).info("Initializing service MyReceiver: {}", activated);
            String iId;
            String sId;
