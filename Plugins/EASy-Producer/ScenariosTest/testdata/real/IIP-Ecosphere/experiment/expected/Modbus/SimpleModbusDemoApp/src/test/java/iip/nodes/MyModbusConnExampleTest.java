...
public class MyModbusConnExampleTest {
    ...
    */
    public static class DataUnit extends BaseDataUnit {
        ...
        /**
        * Returns the value of modbusPhoenixRwEEM.
        *
        * @return the value of modbusPhoenixRwEEM, may be <b>null</b>
        */
        ...
        /**
        * Changes the value of modbusPhoenixRwEEM. [required by Jackson]
        *
    ...
    */
    ...
    /**
    * Creates/returns a predicate asserting that the received data of type ModbusPhoenixEEM as output of the testing 
