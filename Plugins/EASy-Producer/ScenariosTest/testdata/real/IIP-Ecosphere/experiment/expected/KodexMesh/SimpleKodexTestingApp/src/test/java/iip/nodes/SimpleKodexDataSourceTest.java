 ...
 * "../../src/test/resources/testData-SimpleKodexSource.json", the default resource
 * "testData-SimpleKodexSource.json" or "resources/software" if you want to deploy it, e.g., in case of a
...
public class SimpleKodexDataSourceTest extends SpringAsyncServiceBase {
    ...
    */
    public void testSource() throws IOException {
        ...
        createReceptionCallback("data_SimpleKodexSource_KRec13_KodexMeshApp", d -> {
            ...
            printReceivedData(d);
            assertTrue(predKRec13.test(d));
        }, KRec13.class);
        TimeUtils.sleep(5000);
        Service svc = Starter.getMappedService("SimpleKodexSource");
        if (null != svc) {
            try {
                LoggerFactory.getLogger(getClass())
                    .info("Service autostop (test): SimpleKodexSource");
                svc.setState(ServiceState.STOPPING);
            } catch (ExecutionException e) {
                LoggerFactory.getLogger(getClass())
                    .error("Stopping service SimpleKodexSource: {}", e.getMessage());
            }
        }
        System.exit(0);
    }
    ...
    */
    ...
    /**
    * Creates/returns a predicate asserting that the received data of type KRec13 as output of the testing object is ok 
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(SimpleKodexDataSourceTest.class)
