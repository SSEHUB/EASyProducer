...
/**
 * Implements tests for "KodexDataReceiver". The generated class is meant to be re-usable and extensible, e.g., regarding
 ...
 * "../../src/test/resources/testData-KodexReceiver.json", the default resource
 * "testData-KodexReceiver.json" or "resources/software" if you want to deploy it, e.g., in case of a mocked
...
public class KodexDataReceiverTest extends SpringAsyncServiceBase {
    ...
    * "../../src/test/resources/testData-KodexReceiver.json" or the default resource 
    * "testData-KodexReceiver.json".
    *
    * @throws IOException if the data cannot be loaded/mapped to the service input data
    */
    public void testService() throws IOException {
        ...
        try {
            String fileName = System.getProperty("iip.test.dataFile", 
                "../../src/test/resources/testData-KodexReceiver.json");
            LoggerFactory.getLogger(getClass())
    ...
    */
    ...
    public void testKodexReceiverService() throws IOException {
        ...
        Service svc = Starter.getMappedService("KodexReceiver");
        if (null != svc) {
            try {
                LoggerFactory.getLogger(getClass())
                    .info("Service autostop (test): KodexReceiver");
                svc.setState(ServiceState.STOPPING);
            } catch (ExecutionException e) {
                LoggerFactory.getLogger(getClass())
                    .error("Stopping service KodexReceiver: {}", e.getMessage());
            }
        }
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(KodexDataReceiverTest.class)
