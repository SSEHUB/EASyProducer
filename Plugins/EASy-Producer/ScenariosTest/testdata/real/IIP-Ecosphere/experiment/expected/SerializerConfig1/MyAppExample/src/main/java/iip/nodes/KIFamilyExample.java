    ...
    */
    private KIFamilyExampleFamilyInterface selectService(Rec1 data) {
        ...
        if (null != id && !actServiceId.equals(id)) {
            Transport.sendTraceRecord(new TraceRecord("myKiFamily", TraceRecord.ACTION_SWITCHING_SERVICE, 
                actServiceId));
            KIFamilyExampleFamilyInterface newService;
            switch (id) {
            case "myKi": 
            ...
            Transport.sendTraceRecord(new TraceRecord("myKiFamily", TraceRecord.ACTION_SWITCHED_SERVICE, 
                actServiceId));
        }
        return service;
    }
    ...
    public KIFamilyExample() {
        familyStub = new FamilyServiceStub("myKiFamily", AbstractService.getResourceAsStream(KIFamilyExample.class.
            getClassLoader(), "deployment.yml"));
