...
/**
 * IIP-Ecosphere service interface for 'Alternative myKi example'.
 * Generated by: EASy-Producer.
 */
public interface AlternativeMyKiExampleInterface extends Service {

    public static final String SERVICE_ID = "myKi2";
