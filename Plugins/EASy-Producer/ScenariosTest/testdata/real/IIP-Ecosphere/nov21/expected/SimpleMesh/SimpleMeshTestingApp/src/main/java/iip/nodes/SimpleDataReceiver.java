...
public class SimpleDataReceiver {
    ...
    private SimpleDataReceiverService service;
    ...
    public SimpleDataReceiver() {
        service = AbstractService.createInstance("de.iip_ecosphere.platform.test.apps.serviceImpl.SimpleReceiverImpl", SimpleDataReceiverService.class, "SimpleReceiver", "/deployment.yml");
    ...
    */
    ...
    public Consumer<Rec1> receiveRec1_SimpleReceiver() {
        return data -> service.receiveRec1(data);
    }
