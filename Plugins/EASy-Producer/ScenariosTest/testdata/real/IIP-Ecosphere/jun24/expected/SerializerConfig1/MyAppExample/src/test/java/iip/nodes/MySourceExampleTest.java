...
/**
* Implements tests for "MySourceExample". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-mySource.json", the default resource "testData-mySource.json" 
...
public class MySourceExampleTest extends SpringAsyncServiceBase {
    ...
    */
    public void testSource() throws IOException {
        ...
        Service svc = iip.Starter.getMappedService("mySource");
        if (null != svc) {
            try {
                LoggerFactory.getLogger(getClass()).info("Service autostop (test): mySource");
                svc.setState(ServiceState.STOPPING);
            } catch (ExecutionException e) {
                LoggerFactory.getLogger(getClass()).error("Stopping service mySource: {}", e.getMessage());
            }
        }
        System.exit(0);
    }
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(MySourceExampleTest.class).info("Service artifact {} not found in {}", "MyAppExample-0.1.0-SNAPSHOT-bin.jar", "..");
        }
