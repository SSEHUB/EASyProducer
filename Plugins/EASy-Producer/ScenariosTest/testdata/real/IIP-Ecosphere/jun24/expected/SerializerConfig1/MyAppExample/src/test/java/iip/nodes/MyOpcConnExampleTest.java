...
/**
* Implements tests for "MyOpcConnExample". The generated class is meant to be re-usable and extensible, e.g.,
    ...
    */
    protected void testConnector(ConnectorParameter params, ReceptionCallback<MyConnPltfIn> callback) throws IOException {
        ...
        de.iip_ecosphere.platform.connectors.opcuav1.OpcUaConnector<MyConnPltfIn, MyConnPltfOut> conn = 
            new de.iip_ecosphere.platform.connectors.opcuav1.OpcUaConnector<>(MyOpcConnExample.createConnectorAdapter());
        conn.connect(params);
