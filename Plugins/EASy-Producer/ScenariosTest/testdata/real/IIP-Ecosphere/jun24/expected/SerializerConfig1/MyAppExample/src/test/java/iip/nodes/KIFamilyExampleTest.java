...
/**
* Implements tests for "KIFamilyExample". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-myKiFamily.json", the default resource "testData-myKiFamily.json" 
...
* configuration model. The structure for this service is: {@code {"rec1": {"intField": m, "stringField": o}, "$period": p, "$repeats": r}}. Depending
...
public class KIFamilyExampleTest extends SpringAsyncServiceBase {
    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(Rec1Impl.class, d -> {
                                        Message<Rec1Impl> msg = MessageBuilder.withPayload(d).build();
                                        source.send(msg);
            ...
            createReceptionCallback("data_myKiFamily_RtsaTestInput_myApp", d -> {
                ...
                printReceivedData(d);
                Assert.assertTrue(predRtsaTestInput.test(d));
            }, RtsaTestInput.class);
    ...
    * "../../src/test/resources/testData-myKiFamily.json" or the default resource "testData-myKiFamily.json".
    *
    ...
    */
    public void testService() throws IOException {
        InputStream in;
        try {
            String fileName = System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-myKiFamily.json");
    ...
    */
    ...
    /**
    * Creates/returns a predicate asserting that the received data of type RtsaTestInput
    ...
    */
    ...
    public void testMyKiFamilyService() throws IOException {
        ...
        Service svc = iip.Starter.getMappedService("myKiFamily");
        if (null != svc) {
            try {
                LoggerFactory.getLogger(getClass()).info("Service autostop (test): myKiFamily");
                svc.setState(ServiceState.STOPPING);
            } catch (ExecutionException e) {
                LoggerFactory.getLogger(getClass()).error("Stopping service myKiFamily: {}", e.getMessage());
            }
        }
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(KIFamilyExampleTest.class).info("Service artifact {} not found in {}", "MyAppExample-0.1.0-SNAPSHOT-bin.jar", "..");
        }
