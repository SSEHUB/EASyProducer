...
/**
* Implements tests for "MyRtsaExample". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-myRtsa.json", the default resource "testData-myRtsa.json" 
...
* configuration model. The structure for this service is: {@code {"rtsaTestInput": {"id": m, "value1": m, "value2": m}, "$period": p, "$repeats": r}}. Depending
...
public class MyRtsaExampleTest extends SpringAsyncServiceBase {
    ...
    */
    public static class DataUnit extends DataMapper.BaseDataUnit {
        ...
        /**
        * Returns rtsaTestInput.
        *
        * @return rtsaTestInput, may be <b>null</b>
        */
        ...
        /**
        * Changes rtsaTestInput. [required by Jackson]
        *
    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(RtsaTestInputImpl.class, d -> {
                                        ...
                                        Transport.send(c -> c.asyncSend("transformRtsaTestInput_myKiFamily", d), "myKiFamily", "transformRtsaTestInput_myKiFamily-in-0");
                                        // one for async via transport - ignored if spring
                                        Transport.send(c -> c.asyncSend("data_myKiFamily_RtsaTestInput_myApp", d), "myKiFamily", "transformRtsaTestInput_myKiFamily-in-0");
                                    });
            ...
            createReceptionCallback("data_myRtsa_RtsaTestOutput_myApp", d -> {
                ...
                printReceivedData(d);
                Assert.assertTrue(predRtsaTestOutput.test(d));
    ...
    * "../../src/test/resources/testData-myRtsa.json" or the default resource "testData-myRtsa.json".
    *
    ...
    */
    ...
    /**
    * Creates/returns a predicate asserting that the received data of type RtsaTestOutput
    ...
    */
    ...
    public void testMyRtsaService() throws IOException {
        ...
        Service svc = iip.Starter.getMappedService("myRtsa");
        if (null != svc) {
            try {
                LoggerFactory.getLogger(getClass()).info("Service autostop (test): myRtsa");
                svc.setState(ServiceState.STOPPING);
            } catch (ExecutionException e) {
                LoggerFactory.getLogger(getClass()).error("Stopping service myRtsa: {}", e.getMessage());
            }
        }
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(MyRtsaExampleTest.class).info("Service artifact {} not found in {}", "MyAppExample-0.1.0-SNAPSHOT-bin.jar", "..");
        }
