...
public class MyMqttConnExample extends SpringAsyncServiceBase {
    ...
    public MyMqttConnExample() {
        ...
        Connector<byte[], byte[], MyConnPltfIn, MyConnPltfOut> conn = ConnectorFactory.createConnector(
            ...
            createConnectorAdapter(()->service.getInPath("/opc/machIn/"), ()->service.getOutPath("/opc/machOut/")));
    ...
    */
    public static ChannelTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>[] createConnectorAdapter(
        ...
        ChannelTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>[] adapter = new ChannelTranslatingProtocolAdapter[3];
        if (metrics != null) {
            adapter[0] = new MonitoredTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>(
            ...
            adapter[0] = new ChannelTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>(
                "OUT", new ChanneledConnectorOutputTypeAdapter<MyConnPltfIn>(new MyMqttConnExampleParserSerializer("US-ASCII", null, outPathSupplier)), 
                "IN", new ConnectorInputTypeAdapter<MyConnPltfOut>(new MyMqttConnExampleFormatterSerializer("US-ASCII", null, inPathSupplier)));
        }
        if (metrics != null) {
            adapter[1] = new MonitoredTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>(
                "OUT1", new ChanneledConnectorOutputTypeAdapter<MyConnPltfIn>(new MyMqttConnExampleParserSerializer("US-ASCII", null, outPathSupplier)), 
                "IN", new ConnectorInputTypeAdapter<MyConnPltfOut>(new MyMqttConnExampleFormatterSerializer("US-ASCII", null, inPathSupplier)), 
                metrics, log);
        } else {
            adapter[1] = new ChannelTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>(
                "OUT1", new ChanneledConnectorOutputTypeAdapter<MyConnPltfIn>(new MyMqttConnExampleParserSerializer("US-ASCII", null, outPathSupplier)), 
                "IN", new ConnectorInputTypeAdapter<MyConnPltfOut>(new MyMqttConnExampleFormatterSerializer("US-ASCII", null, inPathSupplier)));
        }
        if (metrics != null) {
            adapter[2] = new MonitoredTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>(
                "OUT2", new ChanneledConnectorOutputTypeAdapter<MyConnPltfIn>(new MyMqttConnExampleParserSerializer("US-ASCII", null, outPathSupplier)), 
                "IN", new ConnectorInputTypeAdapter<MyConnPltfOut>(new MyMqttConnExampleFormatterSerializer("US-ASCII", null, inPathSupplier)), 
                metrics, log);
        } else {
            adapter[2] = new ChannelTranslatingProtocolAdapter<byte[], byte[], MyConnPltfIn, MyConnPltfOut>(
                "OUT2", new ChanneledConnectorOutputTypeAdapter<MyConnPltfIn>(new MyMqttConnExampleParserSerializer("US-ASCII", null, outPathSupplier)), 
                "IN", new ConnectorInputTypeAdapter<MyConnPltfOut>(new MyMqttConnExampleFormatterSerializer("US-ASCII", null, inPathSupplier)));
        };
        return adapter;
    ...
    */
    ...
    LoggerFactory.getLogger(getClass()).debug("received in {}: {}", "myMqttConn", data); 
