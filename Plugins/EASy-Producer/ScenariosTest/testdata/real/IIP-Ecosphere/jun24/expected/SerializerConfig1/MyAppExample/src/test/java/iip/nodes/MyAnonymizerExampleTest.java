...
* configuration model. The structure for this service is: {@code {"string": , "myConnPltfIn": {"axis": m, "dataField": m, "nested": m}, "$period": p, "$repeats": r}}. Depending
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        if (null != f && null != yaml.getProcess()) {
            ...
            LoggerFactory.getLogger(MyAnonymizerExampleTest.class).info("Service artifact {} not found in {}", "MyAppExample-0.1.0-SNAPSHOT-bin.jar", "..");
        }
