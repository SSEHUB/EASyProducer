...
public class MyOpcConnExampleTest {
    ...
    public static void main(String[] args) throws IOException {
        SerializerRegistry.registerSerializer(iip.serializers.MyConnPltfInImpl.class);
        SerializerRegistry.registerSerializer(iip.serializers.MyConnPltfIn.class);
        SerializerRegistry.registerSerializer(iip.serializers.MyConnPltfOutImpl.class);
        SerializerRegistry.registerSerializer(iip.serializers.MyConnPltfOut.class);
        
        ConnectorParameter params = MyOpcConnExample
            .createConnectorParameter(); // as configured, or create own and customize
            
        OpcUaConnector<MyConnPltfOut, MyConnPltfIn> conn = new OpcUaConnector<>(
            MyOpcConnExample.createConnectorAdapter());
