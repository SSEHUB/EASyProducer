...
/**
* Implements tests for "ParallelRoutingProcessor1". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-ParallelRoutingProcessor1.json", the default resource "testData-ParallelRoutingProcessor1.json" 
...
@TestPropertySource(properties = {
    "spring.cloud.stream.bindings.processRoutingTestData_ParallelRoutingProcessor1-in-0.destination=processRoutingTestData_RoutingProcessor",
        ...
        "spring.cloud.stream.bindings.receiveRoutingTestData_RoutingSink-in-0.destination=processRoutingTestData_ParallelRoutingProcessor1",
        ...
        "spring.cloud.function.definition=processRoutingTestData_ParallelRoutingProcessor1",
        "iip.service.myRoutingConnector=false",
        "iip.service.myRoutingSource=false",
        "iip.service.ParallelRoutingProcessor1=true",
...
public class ParallelRoutingProcessor1Test extends SpringAsyncServiceBase {
    ...
    */
    private class TestMatcher extends IsAnything<Object> {
        ...
        */
        public TestMatcher() {
            super("ParallelRoutingProcessor1 matcher");
        }
    ...
    */
    public ParallelRoutingProcessor1Test() {
    ...
    */
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            createReceptionCallback("ParallelRoutingProcessor1_RoutingTestData", d -> {
    ...
    * "../../src/test/resources/testData-ParallelRoutingProcessor1.json" or the default resource "testData-ParallelRoutingProcessor1.json".
    *
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-ParallelRoutingProcessor1.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-ParallelRoutingProcessor1.json");
        }
        testService(in);
    }
    ...
    */
    ...
    /**
    * Tests the service with the default resource "testData-ParallelRoutingProcessor1.json".
    *
    * @throws IOException shall not occur / test failure
    */
    @Test
    public void testParallelRoutingProcessor1Service() throws IOException {
        testService();
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        junit.run(ParallelRoutingProcessor1Test.class);
    }
