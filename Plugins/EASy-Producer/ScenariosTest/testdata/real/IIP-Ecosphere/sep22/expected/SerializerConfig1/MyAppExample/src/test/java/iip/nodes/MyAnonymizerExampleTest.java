...
* configuration model. The structure for this service is: {@code {"string": , "myConnPltfIn": {"axis": m, "dataField": m}, "$period": p, "$repeats": r}}. Depending
    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(MyConnPltfInImpl.class, d -> {
                Transport.send(c -> c.asyncSend("myMqttConn_MyConnPltfIn", d), "myMqttConn", "createMyConnPltfIn_myMqttConn-in-0");
            });consumer.addHandler(MyConnPltfInImpl.class, d -> {
                Transport.send(c -> c.asyncSend("myOpcConn_MyConnPltfIn", d), "myOpcConn", "createMyConnPltfIn_myOpcConn-in-0");
            });consumer.addHandler(StringImpl.class, d -> {
                Transport.send(c -> c.asyncSend("mySource_String", d), "mySource", "createString_mySource-in-0");
            });
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-myAnonymizer.json"));
        } catch (IOException e) {
