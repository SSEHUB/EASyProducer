...
/**
 * IIP-Ecosphere supporting service implementation for 'ParallelRoutingProcessor2'.
 * Generated by: EASy-Producer.
 */
public abstract class ParallelRoutingProcessor2Impl extends DefaultServiceImpl implements ParallelRoutingProcessor2Interface {
     ...
     */
    protected ParallelRoutingProcessor2Impl(ServiceKind kind) {
        super(kind);
     ...
     * @param kind the service kind
     */
    protected ParallelRoutingProcessor2Impl(String id, ServiceKind kind) {
        super(id, kind);
        registerParameterConfigurers();
    }
    ...
    */
    protected ParallelRoutingProcessor2Impl(YamlService yaml) {
        super(yaml);
        registerParameterConfigurers();
    }
    ...
    */
    protected ParallelRoutingProcessor2Impl(String serviceId, InputStream ymlFile) {
