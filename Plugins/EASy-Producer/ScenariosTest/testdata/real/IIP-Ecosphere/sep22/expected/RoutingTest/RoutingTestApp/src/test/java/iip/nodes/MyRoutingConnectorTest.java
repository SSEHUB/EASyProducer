...
public class MyRoutingConnectorTest {
    ...
    */
    protected void testConnector(ConnectorParameter params, ReceptionCallback<RoutingConnOut> callback) throws IOException {
        ...
        de.iip_ecosphere.platform.test.apps.serviceImpl.routingTest.ConnectorImpl<RoutingConnOut, RoutingConnIn> conn = 
            new de.iip_ecosphere.platform.test.apps.serviceImpl.routingTest.ConnectorImpl<>(MyRoutingConnector.createConnectorAdapter());
        conn.connect(params);
    ...
    */
    ...
    /**
    * Creates/returns a predicate asserting that the received data of type RoutingConnOut
