...
/**
* Implements tests for "ParallelRoutingProcessor3". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-ParallelRoutingProcessor3.json", the default resource "testData-ParallelRoutingProcessor3.json" 
...
@TestPropertySource(properties = {
    "spring.cloud.stream.bindings.processRoutingTestData_ParallelRoutingProcessor1-in-0.destination=processRoutingTestData_RoutingProcessor",
        ...
        "spring.cloud.stream.bindings.receiveRoutingTestData_RoutingSink-in-0.destination=transformRoutingTestDataRoutingTestData_ParallelRoutingProcessor3",
        ...
        "spring.cloud.function.definition=transformRoutingTestDataRoutingTestData_ParallelRoutingProcessor3",
        ...
        "iip.service.ParallelRoutingProcessor3=true",
        "iip.service.RoutingProcessor=false",
        "iip.service.RoutingSink=false"})
@RunWith(SpringRunner.class)
public class ParallelRoutingProcessor3Test extends SpringAsyncServiceBase {
    ...
    */
    private class TestMatcher extends IsAnything<Object> {
        ...
        */
        public TestMatcher() {
            super("ParallelRoutingProcessor3 matcher");
        }
    ...
    */
    public ParallelRoutingProcessor3Test() {
    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(RoutingTestDataImpl.class, d -> {
                ...
                Message<RoutingTestDataImpl> msg = MessageBuilder.withPayload(d).build();
                source.send(msg);
            ...
            createReceptionCallback("ParallelRoutingProcessor3_RoutingTestData", d -> {
    ...
    * "../../src/test/resources/testData-ParallelRoutingProcessor3.json" or the default resource "testData-ParallelRoutingProcessor3.json".
    *
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-ParallelRoutingProcessor3.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-ParallelRoutingProcessor3.json");
        }
        testService(in);
    }
    ...
    */
    ...
    /**
    * Tests the service with the default resource "testData-ParallelRoutingProcessor3.json".
    *
    * @throws IOException shall not occur / test failure
    */
    @Test
    public void testParallelRoutingProcessor3Service() throws IOException {
        testService();
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        junit.run(ParallelRoutingProcessor3Test.class);
    }
