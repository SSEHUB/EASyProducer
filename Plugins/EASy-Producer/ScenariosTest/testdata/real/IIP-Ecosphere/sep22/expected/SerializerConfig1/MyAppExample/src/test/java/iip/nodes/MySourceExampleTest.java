    ...
    public void testSource() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-mySource.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-mySource.json");
        }
        ...
        createReceptionCallback("mySource_String", d -> {
