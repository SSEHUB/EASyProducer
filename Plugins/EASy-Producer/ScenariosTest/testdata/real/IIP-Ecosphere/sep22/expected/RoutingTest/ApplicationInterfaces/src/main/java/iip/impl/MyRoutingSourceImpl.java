...
/**
 * IIP-Ecosphere supporting service implementation for 'myRoutingSource'.
 * Generated by: EASy-Producer.
 */
public abstract class MyRoutingSourceImpl extends DefaultServiceImpl implements MyRoutingSourceInterface {
     ...
     */
    protected MyRoutingSourceImpl(ServiceKind kind) {
        super(kind);
     ...
     * @param kind the service kind
     */
    protected MyRoutingSourceImpl(String id, ServiceKind kind) {
        super(id, kind);
        registerParameterConfigurers();
    }
    ...
    */
    protected MyRoutingSourceImpl(YamlService yaml) {
        super(yaml);
        registerParameterConfigurers();
    }
    ...
    */
    protected MyRoutingSourceImpl(String serviceId, InputStream ymlFile) {
