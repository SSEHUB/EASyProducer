...
/**
 * IIP-Ecosphere supporting service implementation for 'ParallelRoutingProcessor3'.
 * Generated by: EASy-Producer.
 */
public abstract class ParallelRoutingProcessor3Impl extends DefaultServiceImpl implements ParallelRoutingProcessor3Interface {
     ...
     */
    protected ParallelRoutingProcessor3Impl(ServiceKind kind) {
        super(kind);
     ...
     * @param kind the service kind
     */
    protected ParallelRoutingProcessor3Impl(String id, ServiceKind kind) {
        super(id, kind);
        registerParameterConfigurers();
    }
    ...
    */
    protected ParallelRoutingProcessor3Impl(YamlService yaml) {
        super(yaml);
        registerParameterConfigurers();
    }
    ...
    */
    protected ParallelRoutingProcessor3Impl(String serviceId, InputStream ymlFile) {
