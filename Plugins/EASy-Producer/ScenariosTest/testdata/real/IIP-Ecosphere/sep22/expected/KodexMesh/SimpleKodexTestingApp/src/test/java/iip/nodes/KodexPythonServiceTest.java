...
@TestPropertySource(properties = {
    "spring.cloud.stream.bindings.receiveKRec13Anon_KodexReceiver-in-0.destination=transformKRec13AnonKRec13Anon_KodexPythonService",
        "spring.cloud.stream.bindings.transformKRec13AnonKRec13Anon_KodexPythonService-in-0.destination=processKRec13Anon_Pseudonymizer",
        "spring.cloud.stream.bindings.transformKRec13AnonKRec13Anon_KodexPythonService-in-0.useNativeEncoding=true",
    ...
    */
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            createReceptionCallback("KodexPythonService_KRec13Anon", d -> {
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-KodexPythonService.json"));
        } catch (IOException e) {
