...
@TestPropertySource(properties = {
    "spring.cloud.stream.bindings.processRtsaTestInput_myRtsa-in-0.destination=transformRtsaTestInput_myKiFamily",
        "spring.cloud.stream.bindings.receiveRtsaTestOutput_aasSink-in-0.destination=processRtsaTestOutput_myRtsa",
        "spring.cloud.stream.bindings.receiveRtsaTestOutput_aasSink-in-0.useNativeEncoding=true",
        "spring.cloud.stream.bindings.transformRtsaTestInput_myKiFamily-out-0.destination=transformRtsaTestInput_myKiFamily",
    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(RtsaTestInputImpl.class, d -> {
                Transport.send(c -> c.asyncSend("myKiFamily_RtsaTestInput", d), "myKiFamily", "transformRtsaTestInput_myKiFamily-in-0");
            });
            ...
            createReceptionCallback("myRtsa_RtsaTestOutput", d -> {
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-myRtsa.json"));
        } catch (IOException e) {
