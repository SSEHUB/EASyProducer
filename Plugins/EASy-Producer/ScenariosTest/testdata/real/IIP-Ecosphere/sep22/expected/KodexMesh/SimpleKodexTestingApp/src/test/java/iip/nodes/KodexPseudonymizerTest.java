    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(KRec13Impl.class, d -> {
                Transport.send(c -> c.asyncSend("SimpleKodexSource_KRec13", d), "SimpleKodexSource", "createKRec13_SimpleKodexSource-in-0");
            });
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-Pseudonymizer.json"));
        } catch (IOException e) {
