...
/**
* Implements tests for "MyRoutingSource". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-myRoutingSource.json", the default resource "testData-myRoutingSource.json" 
...
* configuration model. The structure for this service is: {@code {"routingCommand": {"cmd": m}, "$period": p, "$repeats": r}}. Depending
    ...
    public void testSource() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-myRoutingSource.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-myRoutingSource.json");
        }
        ...
        createReceptionCallback("myRoutingSource_RoutingTestData", d -> {
