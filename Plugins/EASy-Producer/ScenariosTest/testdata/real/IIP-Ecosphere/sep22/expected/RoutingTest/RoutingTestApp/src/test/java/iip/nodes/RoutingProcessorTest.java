...
/**
* Implements tests for "RoutingProcessor". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-RoutingProcessor.json", the default resource "testData-RoutingProcessor.json" 
...
* configuration model. The structure for this service is: {@code {"routingTestData": {"serNr": m, "stringField": m}, "routingConnOut": {"serNr": m, "data": m}, "routingCommand": {"cmd": m}, "$period": p, "$repeats": r}}. Depending
...
@TestPropertySource(properties = {
    "spring.cloud.stream.bindings.createRoutingTestData_myRoutingSource-out-0.destination=createRoutingTestData_myRoutingSource",
        "spring.cloud.stream.bindings.processRoutingTestData_ParallelRoutingProcessor1-in-0.destination=processRoutingTestData_RoutingProcessor",
        "spring.cloud.stream.bindings.processRoutingTestData_ParallelRoutingProcessor1-in-0.useNativeEncoding=true",
        "spring.cloud.stream.bindings.processRoutingTestData_ParallelRoutingProcessor2-in-0.destination=processRoutingTestData_RoutingProcessor",
        "spring.cloud.stream.bindings.processRoutingTestData_ParallelRoutingProcessor2-in-0.useNativeEncoding=true",
        "spring.cloud.stream.bindings.processRoutingTestData_RoutingProcessor-in-0.destination=createRoutingTestData_myRoutingSource",
        "spring.cloud.stream.bindings.transformRoutingTestDataRoutingTestData_ParallelRoutingProcessor3-in-0.destination=processRoutingTestData_RoutingProcessor",
        "spring.cloud.stream.bindings.transformRoutingTestDataRoutingTestData_ParallelRoutingProcessor3-in-0.useNativeEncoding=true",
        "spring.cloud.function.definition=processRoutingTestData_RoutingProcessor",
        ...
        "iip.service.RoutingProcessor=true",
        "iip.service.RoutingSink=false"})
@RunWith(SpringRunner.class)
public class RoutingProcessorTest extends SpringAsyncServiceBase {
    ...
    */
    public static class DataUnit extends DataMapper.BaseDataUnit {
        ...
        private RoutingConnOutImpl routingConnOut;
        ...
        */
        ...
        /**
        * Returns routingConnOut.
        *
        * @return routingConnOut, may be <b>null</b>
        */
        public RoutingConnOutImpl getRoutingConnOut() {
            return routingConnOut;
        }
        /**
        * Returns routingCommand.
        *
        * @return routingCommand, may be <b>null</b>
        */
        ...
        */
        ...
        /**
        * Changes routingConnOut. [required by Jackson]
        *
        * @param routingConnOut, the new value, may be <b>null</b>
        */
        public void setRoutingConnOut(RoutingConnOutImpl routingConnOut) {
            this.routingConnOut = routingConnOut;
        }
        /**
        * Changes routingCommand. [required by Jackson]
        *
    ...
    */
    private class TestMatcher extends IsAnything<Object> {
        ...
        */
        public TestMatcher() {
            super("RoutingProcessor matcher");
        }
    ...
    */
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(RoutingConnOutImpl.class, d -> {
                Transport.send(c -> c.asyncSend("myRoutingConnector_RoutingConnOut", d), "myRoutingConnector", "createRoutingConnOut_myRoutingConnector-in-0");
            });consumer.addHandler(RoutingTestDataImpl.class, d -> {
                Transport.send(c -> c.asyncSend("myRoutingSource_RoutingTestData", d), "myRoutingSource", "createRoutingTestData_myRoutingSource-in-0");
            });consumer.addHandler(RoutingTestDataImpl.class, d -> {
                Transport.send(c -> c.asyncSend("RoutingProcessor_RoutingTestData", d), "RoutingProcessor", "processRoutingTestData_RoutingProcessor-in-0");
            });
            ...
            createReceptionCallback("RoutingProcessor_RoutingTestData", d -> {
                incrementReceived(RoutingTestData.class); 
                printReceivedData(d);
                Assert.assertTrue(predRoutingTestData.test(d));
    ...
    * "../../src/test/resources/testData-RoutingProcessor.json" or the default resource "testData-RoutingProcessor.json".
    *
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-RoutingProcessor.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-RoutingProcessor.json");
        }
        testService(in);
    }
    ...
    */
    ...
    /**
    * Creates/returns a predicate asserting that the received data of type RoutingTestData
    ...
    */
    ...
    /**
    * Tests the service with the default resource "testData-RoutingProcessor.json".
    *
    * @throws IOException shall not occur / test failure
    */
    @Test
    public void testRoutingProcessorService() throws IOException {
        testService();
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        junit.run(RoutingProcessorTest.class);
    }
