...
@TestPropertySource(properties = {
    "spring.cloud.stream.bindings.processRtsaTestInput_myRtsa-in-0.destination=transformRtsaTestInput_myKiFamily",
        "spring.cloud.stream.bindings.transformRec1RtsaTestInput_myKiFamily-in-0.destination=processRec1_myAnonymizer",
        "spring.cloud.stream.bindings.transformRec1RtsaTestInput_myKiFamily-in-0.useNativeEncoding=true",
        "spring.cloud.stream.bindings.transformRtsaTestInput_myKiFamily-out-0.destination=transformRtsaTestInput_myKiFamily",
        "spring.cloud.function.definition=transformRec1RtsaTestInput_myKiFamily;transformRtsaTestInput_myKiFamily",
    ...
    */
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            createReceptionCallback("myKiFamily_RtsaTestInput", d -> {
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-myKiFamily.json"));
        } catch (IOException e) {
