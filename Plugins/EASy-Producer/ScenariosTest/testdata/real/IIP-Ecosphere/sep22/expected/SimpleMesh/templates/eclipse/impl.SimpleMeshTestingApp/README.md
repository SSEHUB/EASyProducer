# Service implementation project for impl.SimpleMeshTestingApp.

Contains a template project for service implementations for impl.SimpleMeshTestingApp. The configuration model is assumed to be 
...
Typical build steps:
 ...
 implement individual services, this execution renders useless.
  - `mvn -P App exec:java@SimpleDataReceiverTest` executes the service/connector test for `SimpleDataReceiver` - `mvn -P App exec:java@SimpleDataSourceTest` executes the service/connector test for `SimpleDataSource`
