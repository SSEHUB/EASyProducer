...
/**
* Implements tests for "ParallelRoutingProcessor2". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-ParallelRoutingProcessor2.json", the default resource "testData-ParallelRoutingProcessor2.json" 
...
* configuration model. The structure for this service is: {@code {"routingTestData": {"serNr": m, "stringField": m}, "routingCommand": {"cmd": m}, "$period": p, "$repeats": r}}. Depending
...
@TestPropertySource(properties = {
    "spring.cloud.stream.bindings.processRoutingTestData_ParallelRoutingProcessor1-in-0.destination=processRoutingTestData_RoutingProcessor",
        ...
        "spring.cloud.stream.bindings.receiveRoutingTestData_RoutingSink-in-0.destination=processRoutingTestData_ParallelRoutingProcessor2",
...
public class ParallelRoutingProcessor2Test extends SpringAsyncServiceBase {
    ...
    */
    private class TestMatcher extends IsAnything<Object> {
        ...
        */
        public TestMatcher() {
            super("ParallelRoutingProcessor2 matcher");
        }
    ...
    */
    public ParallelRoutingProcessor2Test() {
    ...
    */
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            createReceptionCallback("ParallelRoutingProcessor2_RoutingTestData", d -> {
    ...
    * "../../src/test/resources/testData-ParallelRoutingProcessor2.json" or the default resource "testData-ParallelRoutingProcessor2.json".
    *
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-ParallelRoutingProcessor2.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-ParallelRoutingProcessor2.json");
        }
        testService(in);
    }
    ...
    */
    ...
    /**
    * Tests the service with the default resource "testData-ParallelRoutingProcessor2.json".
    *
    * @throws IOException shall not occur / test failure
    */
    @Test
    public void testParallelRoutingProcessor2Service() throws IOException {
        testService();
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        junit.run(ParallelRoutingProcessor2Test.class);
    }
