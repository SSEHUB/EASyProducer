    ...
    public void testSource() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-SimpleSource3.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-SimpleSource3.json");
        }
        ...
        createReceptionCallback("SimpleSource3_Rec13", d -> {
