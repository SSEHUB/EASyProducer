    ...
    public void testService(InputStream in) throws IOException {
        try (ConfigurableApplicationContext context = new SpringApplicationBuilder(
            ...
            consumer.addHandler(RtsaTestOutputImpl.class, d -> {
                Transport.send(c -> c.asyncSend("myRtsa_RtsaTestOutput", d), "myRtsa", "processRtsaTestOutput_myRtsa-in-0");
            });
    ...
    public void testService() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-aasSink.json"));
        } catch (IOException e) {
