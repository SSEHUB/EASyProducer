...
/**
* Implements tests for "SimpleDataSource". The generated class is meant to be re-usable and extensible, e.g.,
...
* property "iip.test.dataFile", "../../src/test/resources/testData-SimpleSource.json", the default resource "testData-SimpleSource.json" 
...
@TestPropertySource(properties = {
    "spring.cloud.function.definition=createRec1_SimpleSource",
        "iip.service.SimpleReceiver=false",
        "iip.service.SimpleSource=true"})
...
public class SimpleDataSourceTest extends SpringAsyncServiceBase {
    ...
    public void testSource() throws IOException {
        ...
        try {
            in = new java.io.FileInputStream(
                System.getProperty("iip.test.dataFile", "../../src/test/resources/testData-SimpleSource.json"));
        } catch (IOException e) {
            in = ResourceLoader.getResourceAsStream("testData-SimpleSource.json");
        }
        ...
        final Predicate<Rec1> predRec1 = getAssertPredicateRec1();
        createReceptionCallback("SimpleSource_Rec1", d -> {
            incrementReceived(Rec1.class); 
            printReceivedData(d);
            Assert.assertTrue(predRec1.test(d));
        }, Rec1.class);
    }
    ...
    */
    public static void main(String[] args) throws IOException {
        ...
        junit.run(SimpleDataSourceTest.class);
    }
