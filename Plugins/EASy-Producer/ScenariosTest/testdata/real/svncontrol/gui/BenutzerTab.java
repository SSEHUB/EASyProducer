...
public class BenutzerTab extends FrameParentComponentListenerPanel {

    public static final String CONF_NAME = 
        BenutzerTab.class.getSimpleName().toLowerCase();
    
    private BenutzerTab(JFrame parent, Client client) {
        super(parent);
    }
    
    static void create(JFrame parent, JTabbedPane tabs, 
        Client client) {
        tabs.add(MAINTAB_USERS.format(), 
            new BenutzerTab(parent, client));
    }
