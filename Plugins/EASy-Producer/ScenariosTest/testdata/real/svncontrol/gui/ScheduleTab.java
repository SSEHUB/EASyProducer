...
@Component(boundTo="OPT_SCHEDULES", packageAlways=false, replaceThis=false)
@SuppressWarnings("serial")
public class ScheduleTab extends FrameParentComponentListenerPanel {

    public static final String CONF_NAME = 
        ScheduleTab.class.getSimpleName().toLowerCase();
    
    private ScheduleTab(JFrame parent, Client client) {
        super(parent);
    }

    static void create(JFrame parent, JTabbedPane tabs, 
        Client client) {
        tabs.add(MAINTAB_SCHEDULER.format(), 
            new ScheduleTab(parent, client));
    }
