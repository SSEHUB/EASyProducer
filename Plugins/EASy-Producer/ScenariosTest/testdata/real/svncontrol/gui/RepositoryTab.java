...
public class RepositoryTab extends FrameParentComponentListenerPanel {

    public static final String CONF_NAME = 
        RepositoryTab.class.getSimpleName().toLowerCase();

    private RepositoryTab(JFrame parent, Client client) {
        super(parent);
    }
    
    static void create(JFrame parent, JTabbedPane tabs, 
        Client client) {
        tabs.add(MAINTAB_REPOSITORIES.format(), 
            new RepositoryTab(parent, client));
    }
