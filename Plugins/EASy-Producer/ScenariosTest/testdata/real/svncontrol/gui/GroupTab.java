...
public class GroupTab extends FrameParentComponentListenerPanel {
    
    public static final String CONF_NAME = 
        GroupTab.class.getSimpleName().toLowerCase();
    
    private GroupTab(JFrame parent, Client client) {
        super(parent);
    }

    static void create(JFrame parent, JTabbedPane tabs, 
        Client client) {
        tabs.add(MAINTAB_GROUPS.format(), 
            new GroupTab(parent, client));
    }
