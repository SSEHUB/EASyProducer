...
public interface ITwitterStreamData {
    ...
    **/
    public static interface ITwitterStreamData1Output extends Serializable{
        /**
    ...
    * Define the source data input interface.
    **/
    public static interface ITwitterStreamData2Output extends Serializable{
        /**
    ...
    * @return ITwitterStreamData1Output the source data
    **/
    public ITwitterStreamData1Output getData1();
    /**
    * Returns a specific type of data source.
    * @return ITwitterStreamData2Output the source data
    **/
    public ITwitterStreamData2Output getData2();
