...
public class PipelineVar_8_FamilyElement0FamilyElement extends BaseSignalBolt {
    ...
    private String streamId = "PipelineVar_8_FamilyElement0StreamPreprocessedStream";
    private transient IIFPreprocessorPreprocessedStreamOutput result = new FPreprocessor.IFPreprocessorPreprocessedStreamOutput();
    ...
    private static void sendAlgorithmChangeEvent(String algorithm) {
        EventManager.send(new AlgorithmChangedMonitoringEvent("DynamicGraphPip", "PipelineVar_8_FamilyElement0", algorithm));
    }
    ...
    private static void sendDefaultModeMonitoringEvent(DefaultModeException exceptionCase) {
        EventManager.send(new DefaultModeMonitoringEvent("DynamicGraphPip", "PipelineVar_8_FamilyElement0", exceptionCase));
    }

    public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector) {
        super.prepare(map, topologyContext, collector);
        result = new FPreprocessor.IFPreprocessorPreprocessedStreamOutput();
        try {
        ...
        streamId = "PipelineVar_8_FamilyElement0StreamPreprocessedStream";
    ...
    public void execute(Tuple tuple) {
        ...
        if(!(alg instanceof ITopologyCreate)) {
            eu.qualimaster.base.algorithm.IOutputItemIterator<IIFPreprocessorPreprocessedStreamOutput> iter = result.iterator();
            iter.reset();
            while (iter.hasNext()) {
                IIFPreprocessorPreprocessedStreamOutput out = iter.next();
...
//		 _collector.ack(tuple);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_8_FamilyElement0StreamPreprocessedStream", new Fields("IIFPreprocessorPreprocessedStreamOutput"));
    }
