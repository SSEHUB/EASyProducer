...
public class PipelineVar_7_FamilyElement8FamilyElement extends BaseSignalBolt {
    ...
    private String streamId = "PipelineVar_7_FamilyElement8StreamEdgeStream";
    ...
    private static void sendAlgorithmChangeEvent(String algorithm) {
        EventManager.send(new AlgorithmChangedMonitoringEvent("FocusPip", "PipelineVar_7_FamilyElement8", algorithm));
    }
    ...
    private static void sendDefaultModeMonitoringEvent(DefaultModeException exceptionCase) {
        EventManager.send(new DefaultModeMonitoringEvent("FocusPip", "PipelineVar_7_FamilyElement8", exceptionCase));
    }
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector) {
        ...
        streamId = "PipelineVar_7_FamilyElement8StreamEdgeStream";
...
//		 _collector.ack(tuple);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_7_FamilyElement8StreamEdgeStream", new Fields("IIFDynamicGraphCompilationEdgeStreamOutput"));
        declarer.declareStream("PipelineVar_7_FamilyElement81TopoStream", new Fields("IIFDynamicGraphCompilationEdgeStreamOutput"));
    }
