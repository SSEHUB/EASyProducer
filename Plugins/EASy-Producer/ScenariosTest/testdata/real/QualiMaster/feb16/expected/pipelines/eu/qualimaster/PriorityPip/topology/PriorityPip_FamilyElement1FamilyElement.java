...
public class PriorityPip_FamilyElement1FamilyElement extends BaseSignalBolt {
    ...
    private String streamId = "PriorityPip_FamilyElement1StreamPreprocessedStream";
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector) {
        ...
        streamId = "PriorityPip_FamilyElement1StreamPreprocessedStream";
...
//		 _collector.ack(tuple);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PriorityPip_FamilyElement1StreamPreprocessedStream", new Fields("IIFPreprocessorPreprocessedStreamOutput"));
    }
