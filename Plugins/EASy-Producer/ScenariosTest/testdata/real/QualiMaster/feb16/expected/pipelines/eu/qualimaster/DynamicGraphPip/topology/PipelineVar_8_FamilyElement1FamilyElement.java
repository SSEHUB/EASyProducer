...
public class PipelineVar_8_FamilyElement1FamilyElement extends BaseSignalBolt {
    ...
    private String streamId = "PipelineVar_8_FamilyElement1StreamPairwiseFinancial";
    ...
    private static void sendAlgorithmChangeEvent(String algorithm) {
        EventManager.send(new AlgorithmChangedMonitoringEvent("DynamicGraphPip", "PipelineVar_8_FamilyElement1", algorithm));
    }
    ...
    private static void sendDefaultModeMonitoringEvent(DefaultModeException exceptionCase) {
        EventManager.send(new DefaultModeMonitoringEvent("DynamicGraphPip", "PipelineVar_8_FamilyElement1", exceptionCase));
    }
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector) {
        ...
        streamId = "PipelineVar_8_FamilyElement11TopoStream";
...
//		 _collector.ack(tuple);
        ...
        switch (signal.getAlgorithm()) {
            ...
            case "TopoHardwareCorrelationFinancial":
                if(!(alg instanceof TopoHardwareCorrelationFinancial)) {
                    ...
                    streamId = "PipelineVar_8_FamilyElement12TopoStream";
                    alg.setParameterWindowSize(30);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_8_FamilyElement1StreamPairwiseFinancial", new Fields("IIFCorrelationFinancialPairwiseFinancialOutput"));
        declarer.declareStream("PipelineVar_8_FamilyElement11TopoStream", new Fields("IIFCorrelationFinancialPairwiseFinancialOutput"));
        declarer.declareStream("PipelineVar_8_FamilyElement12TopoStream", new Fields("IIFCorrelationFinancialPairwiseFinancialOutput"));
    }
