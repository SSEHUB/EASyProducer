...
public class PipelineVar_7_FamilyElement6FamilyElement extends BaseSignalBolt {
    ...
    private String streamId = "PipelineVar_7_FamilyElement6StreamPreprocessedStream";
    ...
    private static void sendAlgorithmChangeEvent(String algorithm) {
        EventManager.send(new AlgorithmChangedMonitoringEvent("FocusPip", "PipelineVar_7_FamilyElement6", algorithm));
    }
    ...
    private static void sendDefaultModeMonitoringEvent(DefaultModeException exceptionCase) {
        EventManager.send(new DefaultModeMonitoringEvent("FocusPip", "PipelineVar_7_FamilyElement6", exceptionCase));
    }
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector) {
        ...
        streamId = "PipelineVar_7_FamilyElement6StreamPreprocessedStream";
...
//		 _collector.ack(tuple);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_7_FamilyElement6StreamPreprocessedStream", new Fields("IIFPreprocessorPreprocessedStreamOutput"));
    }
