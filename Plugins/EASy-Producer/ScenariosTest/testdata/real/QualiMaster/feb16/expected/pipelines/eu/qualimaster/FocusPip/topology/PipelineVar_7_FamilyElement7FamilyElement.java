...
public class PipelineVar_7_FamilyElement7FamilyElement extends BaseSignalBolt {
    ...
    private String streamId = "PipelineVar_7_FamilyElement7StreamPairwiseFinancial";
    ...
    private static void sendAlgorithmChangeEvent(String algorithm) {
        EventManager.send(new AlgorithmChangedMonitoringEvent("FocusPip", "PipelineVar_7_FamilyElement7", algorithm));
    }
    ...
    private static void sendDefaultModeMonitoringEvent(DefaultModeException exceptionCase) {
        EventManager.send(new DefaultModeMonitoringEvent("FocusPip", "PipelineVar_7_FamilyElement7", exceptionCase));
    }
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector) {
        ...
        streamId = "PipelineVar_7_FamilyElement71TopoStream";
...
//		 _collector.ack(tuple);
        ...
        switch (signal.getAlgorithm()) {
            ...
            case "TopoHardwareCorrelationFinancial":
                if(!(alg instanceof TopoHardwareCorrelationFinancial)) {
                    ...
                    streamId = "PipelineVar_7_FamilyElement72TopoStream";
                    alg.setParameterWindowSize(30);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_7_FamilyElement7StreamPairwiseFinancial", new Fields("IIFCorrelationFinancialPairwiseFinancialOutput"));
        declarer.declareStream("PipelineVar_7_FamilyElement71TopoStream", new Fields("IIFCorrelationFinancialPairwiseFinancialOutput"));
        declarer.declareStream("PipelineVar_7_FamilyElement72TopoStream", new Fields("IIFCorrelationFinancialPairwiseFinancialOutput"));
    }
