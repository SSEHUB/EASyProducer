...
public class PipelineVar_2_Source0Source extends BaseSignalSpout {
    ...
    private static void sendAlgorithmChangeEvent(String algorithm) {
        EventManager.send(new AlgorithmChangedMonitoringEvent("SwitchPip", "PipelineVar_2_Source0", algorithm));
    }
    ...
    public void nextTuple() {
        ...
        if(dataItemRandomData!=null){
            _collector.emit("PipelineVar_2_Source0StreamRandomData", new Values(dataItemRandomData));
            emitted = true;
        }
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_2_Source0StreamRandomData", new Fields("datastreamRandomData"));
    }
}
