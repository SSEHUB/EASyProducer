...
/**
 * Command handler for pulling a parent configuration.
 * 
 * @author Holger Eichelberger
 */
public class PullConfigurationHandler extends AbstractPlpHandler {

    @Override
    protected void execute(ExecutionEvent event, IProject project, ProductLineProject plp) throws ExecutionException {
        ProductLineCommands.pullConfigurationFromPredecessors(HandlerUtil.getActiveShell(event), plp);
    }
