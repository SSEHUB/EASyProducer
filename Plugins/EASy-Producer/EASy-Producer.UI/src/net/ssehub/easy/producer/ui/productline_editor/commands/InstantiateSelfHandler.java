...
/**
 * Command handler for self-instantiation of a PLP.
 * 
 * @author Holger Eichelberger
 */
public class InstantiateSelfHandler extends AbstractPlpHandler {

    @Override
    protected void execute(ExecutionEvent event, IProject project, ProductLineProject plp) throws ExecutionException {
        ProductLineCommands.instantiateProductLine(HandlerUtil.getActiveShell(event), plp, true);
    }
