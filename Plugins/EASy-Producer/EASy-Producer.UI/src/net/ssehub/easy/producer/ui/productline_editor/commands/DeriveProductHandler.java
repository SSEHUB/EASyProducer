...
/**
 * Command handler for deriving a product PLP.
 * 
 * @author Holger Eichelberger
 */
public class DeriveProductHandler extends AbstractPlpHandler {

    @Override
    protected void execute(ExecutionEvent event, IProject project, ProductLineProject plp) throws ExecutionException {
        ProductLineCommands.createProductLineMember(HandlerUtil.getActiveShell(event), plp);
    }
