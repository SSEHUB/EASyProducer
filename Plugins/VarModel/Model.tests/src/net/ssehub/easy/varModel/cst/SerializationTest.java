...
public class SerializationTest {
    ...
    public void testNoArgConstructors() {
        ClassTestUtils.assertNoArgConstructor(AttributeVariable.class, CompoundAccess.class, ConstantValue.class, 
            ContainerOperationCall.class, IfThen.class, OCLFeatureCall.class, Parenthesis.class, Self.class, 
            Variable.class);
    }
