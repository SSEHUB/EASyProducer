		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRuleDeclarationAccess().getGroup_4(), "rule__RuleDeclaration__Group_4__0");
					put(grammarAccess.getRuleDeclarationAccess().getGroup_4_1(), "rule__RuleDeclaration__Group_4_1__0");
					...
					put(grammarAccess.getRuleDeclarationAccess().getNameAssignment_1_1(), "rule__RuleDeclaration__NameAssignment_1_1");
					put(grammarAccess.getRuleDeclarationAccess().getParamListAssignment_1_3(), "rule__RuleDeclaration__ParamListAssignment_1_3");
					put(grammarAccess.getRuleDeclarationAccess().getPostconditionAssignment_2(), "rule__RuleDeclaration__PostconditionAssignment_2");
					put(grammarAccess.getRuleDeclarationAccess().getPreconditionsAssignment_4_0(), "rule__RuleDeclaration__PreconditionsAssignment_4_0");
					put(grammarAccess.getRuleDeclarationAccess().getPreconditionsAssignment_4_1_1(), "rule__RuleDeclaration__PreconditionsAssignment_4_1_1");
					put(grammarAccess.getRuleDeclarationAccess().getBlockAssignment_5(), "rule__RuleDeclaration__BlockAssignment_5");
					...
					put(grammarAccess.getRuleElementAccess().getDeferDeclAssignment_2(), "rule__RuleElement__DeferDeclAssignment_2");
					put(grammarAccess.getRuleModifierAccess().getProtectedAssignment(), "rule__RuleModifier__ProtectedAssignment");
					put(grammarAccess.getDeferDeclarationAccess().getNameAssignment_1(), "rule__DeferDeclaration__NameAssignment_1");
					put(grammarAccess.getDeferDeclarationAccess().getDependsAssignment_2_1(), "rule__DeferDeclaration__DependsAssignment_2_1");
					put(grammarAccess.getDeferDeclarationAccess().getDependsAssignment_2_2_1(), "rule__DeferDeclaration__DependsAssignment_2_2_1");
					...
					put(grammarAccess.getCallAccess().getParamAssignment_2(), "rule__Call__ParamAssignment_2");
