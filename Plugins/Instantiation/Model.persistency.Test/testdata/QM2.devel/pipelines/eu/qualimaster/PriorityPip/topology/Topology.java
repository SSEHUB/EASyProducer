...
public class Topology{
    ...
    public static class MainTopologyCreator implements IMainTopologyCreate {
        ...
        public TopologyOutput createMainTopology() {
            ...
            BoltDeclarer PriorityPip_FamilyElement3 = builder.setBolt("PriorityPip_FamilyElement3", new PriorityPip_FamilyElement3FamilyElement("PriorityPip_FamilyElement3", "PriorityPip"), 1).setNumTasks(1);
