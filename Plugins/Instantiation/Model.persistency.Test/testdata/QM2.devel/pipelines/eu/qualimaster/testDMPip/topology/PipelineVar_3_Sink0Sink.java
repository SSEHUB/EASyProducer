...
public class PipelineVar_3_Sink0Sink extends BaseSignalBolt {
	...
	public PipelineVar_3_Sink0Sink(String name, String namespace) {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_3_Sink0Stream", new Fields("sinkData"));
    }
