...
public class PipelineVar_4_Sink0Sink extends BaseSignalBolt {
	...
	public PipelineVar_4_Sink0Sink(String name, String namespace) {
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_4_Sink0Stream", new Fields("sinkData"));
    }
