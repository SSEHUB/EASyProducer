...
public class PipelineVar_4_FamilyElement0FamilyElement extends BaseSignalBolt {

    final static Logger logger = Logger.getLogger(PipelineVar_4_FamilyElement0FamilyElement.class);
    transient OutputCollector _collector;
    private static String streamId = "PipelineVar_4_FamilyElement0StreamRandomData";
    ...
    public PipelineVar_4_FamilyElement0FamilyElement(String name, String namespace) {
    ...
    private static void sendAlgorithmChangeEvent(String algorithm) {
        EventManager.send(new AlgorithmChangedMonitoringEvent("AggregatePip", "PipelineVar_4_FamilyElement0", algorithm));
    }
    ...
    private static void sendDefaultModeMonitoringEvent(DefaultModeException exceptionCase) {
        EventManager.send(new DefaultModeMonitoringEvent("AggregatePip", "PipelineVar_4_FamilyElement0", exceptionCase));
    }
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector collector) {
        ...
        streamId = "PipelineVar_4_FamilyElement0StreamRandomData";
...
//		 _collector.ack(tuple);
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_4_FamilyElement0StreamRandomData", new Fields("IIAggregateFamilyRandomDataOutput"));
    }
