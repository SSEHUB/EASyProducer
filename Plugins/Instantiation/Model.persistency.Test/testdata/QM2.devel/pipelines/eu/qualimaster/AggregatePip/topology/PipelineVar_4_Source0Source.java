...
public class PipelineVar_4_Source0Source extends BaseSignalSpout {
    ...
    public PipelineVar_4_Source0Source(String name, String namespace) {
    ...
    private static void sendDefaultModeMonitoringEvent(DefaultModeException exceptionCase) {
        EventManager.send(new DefaultModeMonitoringEvent("AggregatePip", "PipelineVar_4_Source0", exceptionCase));
    }
    @Override
    public void nextTuple() {
        long start = System.currentTimeMillis();
        boolean emitted = false;
        // Emitting stream "PipelineVar_4_Source0StreamRandomData".
        try {
        ...
        if(dataItemRandomData!=null){
            _collector.emit("PipelineVar_4_Source0StreamRandomData", new Values(dataItemRandomData));
            emitted = true;
        }
    ...
    public void declareOutputFields(OutputFieldsDeclarer declarer) {
        declarer.declareStream("PipelineVar_4_Source0StreamRandomData", new Fields("datastreamRandomData"));
    }
}
