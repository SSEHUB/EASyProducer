...
public class FTwitterEventDetection implements IFTwitterEventDetection {
    ...
    /**
     * Provides a default implementation of the data input for the {@link IFTwitterEventDetectionAnalysisInput} algorithm.
     * Actual execution system code may also directly wrap the respective tuple concept.
     */
    public static class IFTwitterEventDetectionAnalysisInput implements IIFTwitterEventDetectionAnalysisInput {
        ...
        static {
            SerializerRegistry.register("IFTwitterEventDetectionAnalysisInput", FTwitterEventDetectionSerializers.IFTwitterEventDetectionAnalysisInputSerializer.class);
        }
    }

    /**
     * Provides a default implementation of the data output for the {@link IFTwitterEventDetectionAnalysisOutput} algorithm.
     * Actual execution system code may also directly wrap the respective tuple concept.
     */
    public static class IFTwitterEventDetectionAnalysisOutput implements IIFTwitterEventDetectionAnalysisOutput {
        ...
        static {
            SerializerRegistry.register("IFTwitterEventDetectionAnalysisOutput", FTwitterEventDetectionSerializers.IFTwitterEventDetectionAnalysisOutputSerializer.class);
        }
    }
