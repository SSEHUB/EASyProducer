...
public interface Alternative extends EObject
{
   ...
   * @see de.uni_hildesheim.sse.vilBuildLanguage.VilBuildLanguagePackage#getAlternative_Expr()
  ...
  /**
   * Sets the value of the '{@link de.uni_hildesheim.sse.vilBuildLanguage.Alternative#getExpr <em>Expr</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uni_hildesheim.sse.vilBuildLanguage.VilBuildLanguagePackage#getAlternative_If()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uni_hildesheim.sse.vilBuildLanguage.Alternative#getIf <em>If</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see de.uni_hildesheim.sse.vilBuildLanguage.VilBuildLanguagePackage#getAlternative_Else()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link de.uni_hildesheim.sse.vilBuildLanguage.Alternative#getElse <em>Else</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
