...
public class VilBuildLanguageSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_LanguageUnit_SemicolonKeyword_12_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (VilBuildLanguageGrammarAccess) access;
		...
		match_LanguageUnit_SemicolonKeyword_12_q = new TokenAlias(false, true, grammarAccess.getLanguageUnitAccess().getSemicolonKeyword_12());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if (match_LanguageUnit_SemicolonKeyword_12_q.equals(syntax))
				emit_LanguageUnit_SemicolonKeyword_12_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 * </pre>
	 */
	protected void emit_LanguageUnit_SemicolonKeyword_12_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
