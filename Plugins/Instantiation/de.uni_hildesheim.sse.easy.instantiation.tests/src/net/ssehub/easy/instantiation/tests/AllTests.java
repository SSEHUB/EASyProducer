 ...
 */
package net.ssehub.easy.instantiation.tests;
...
@SuiteClasses({
    // Instantiator Core
    net.ssehub.easy.instantiation.core.AllTests.class,
    // Buildlang
    test.de.uni_hildesheim.sse.vil.buildlang.AllTests.class,
    // XML serializer
    net.ssehub.easy.instantiation.serializer.xml.AllTests.class
    })
