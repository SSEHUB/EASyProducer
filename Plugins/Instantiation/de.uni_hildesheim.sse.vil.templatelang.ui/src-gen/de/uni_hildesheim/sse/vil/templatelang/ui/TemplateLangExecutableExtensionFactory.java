...
public class TemplateLangExecutableExtensionFactory extends AbstractGuiceAwareExecutableExtensionFactory {
	...
	protected Bundle getBundle() {
		return TemplateLangActivator.getInstance().getBundle();
	}
	
	@Override
	protected Injector getInjector() {
		return TemplateLangActivator.getInstance().getInjector(TemplateLangActivator.DE_UNI_HILDESHEIM_SSE_VIL_TEMPLATELANG_TEMPLATELANG);
	}
