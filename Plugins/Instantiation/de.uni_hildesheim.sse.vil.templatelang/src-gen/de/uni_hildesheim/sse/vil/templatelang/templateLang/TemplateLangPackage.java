...
public interface TemplateLangPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link de.uni_hildesheim.sse.vil.templatelang.templateLang.impl.SubCallImpl <em>Sub Call</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.impl.SubCallImpl
   * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.impl.TemplateLangPackageImpl#getSubCall()
   * @generated
   */
  int SUB_CALL = 16;
   ...
   * @ordered
   */
  int SUB_CALL__TYPE = ExpressionDslPackage.SUB_CALL__TYPE;
   ...
   * @ordered
   */
  int SUB_CALL__CALL = ExpressionDslPackage.SUB_CALL__CALL;
   ...
   * @ordered
   */
  int SUB_CALL__ARRAY_EX = ExpressionDslPackage.SUB_CALL__ARRAY_EX;
   ...
   * @ordered
   */
  int SUB_CALL__VAR_TYPE = ExpressionDslPackage.SUB_CALL_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int SUB_CALL__ID = ExpressionDslPackage.SUB_CALL_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int SUB_CALL__NESTED = ExpressionDslPackage.SUB_CALL_FEATURE_COUNT + 2;
   ...
   * @ordered
   */
  int SUB_CALL_FEATURE_COUNT = ExpressionDslPackage.SUB_CALL_FEATURE_COUNT + 3;
  ...
  /**
   * Returns the meta object for class '{@link de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall <em>Sub Call</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Sub Call</em>'.
   * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall
   * @generated
   */
  EClass getSubCall();

  /**
   * Returns the meta object for the containment reference '{@link de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall#getVarType <em>Var Type</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference '<em>Var Type</em>'.
   * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall#getVarType()
   * @see #getSubCall()
   * @generated
   */
  EReference getSubCall_VarType();

  /**
   * Returns the meta object for the attribute '{@link de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall#getId <em>Id</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Id</em>'.
   * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall#getId()
   * @see #getSubCall()
   * @generated
   */
  EAttribute getSubCall_Id();

  /**
   * Returns the meta object for the containment reference list '{@link de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall#getNested <em>Nested</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Nested</em>'.
   * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall#getNested()
   * @see #getSubCall()
   * @generated
   */
  EReference getSubCall_Nested();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link de.uni_hildesheim.sse.vil.templatelang.templateLang.impl.SubCallImpl <em>Sub Call</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.impl.SubCallImpl
     * @see de.uni_hildesheim.sse.vil.templatelang.templateLang.impl.TemplateLangPackageImpl#getSubCall()
     ...
     * @generated
     */
    EReference SUB_CALL__VAR_TYPE = eINSTANCE.getSubCall_VarType();
     ...
     * @generated
     */
    EAttribute SUB_CALL__ID = eINSTANCE.getSubCall_Id();
     ...
     * @generated
     */
    EReference SUB_CALL__NESTED = eINSTANCE.getSubCall_Nested();
