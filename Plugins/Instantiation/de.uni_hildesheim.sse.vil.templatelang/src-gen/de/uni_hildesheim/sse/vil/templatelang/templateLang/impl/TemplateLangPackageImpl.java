...
public class TemplateLangPackageImpl extends EPackageImpl implements TemplateLangPackage
{
   ...
   */
  @Override
  public EReference getSubCall_VarType()
  {
   ...
   */
  @Override
  public EAttribute getSubCall_Id()
  {
    return (EAttribute)subCallEClass.getEStructuralFeatures().get(1);
  }
   ...
   */
  @Override
  public EReference getSubCall_Nested()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(subCallEClass, SUB_CALL__VAR_TYPE);
    createEAttribute(subCallEClass, SUB_CALL__ID);
    createEReference(subCallEClass, SUB_CALL__NESTED);
  ...
  public void initializePackageContents()
  {
    ...
    subCallEClass.getESuperTypes().add(theExpressionDslPackage.getSubCall());
    ...
    initEReference(getSubCall_VarType(), theExpressionDslPackage.getType(), null, "varType", null, 0, 1, SubCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSubCall_Id(), ecorePackage.getEString(), "id", null, 0, 1, SubCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSubCall_Nested(), this.getStmt(), null, "nested", null, 0, -1, SubCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
