...
public class TemplateLangAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected TemplateLangSwitch<Adapter> modelSwitch =
    new TemplateLangSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseExpressionDsl_SubCall(de.uni_hildesheim.sse.vil.expressions.expressionDsl.SubCall object)
      {
        return createExpressionDsl_SubCallAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link de.uni_hildesheim.sse.vil.templatelang.templateLang.SubCall <em>Sub Call</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createExpressionDsl_SubCallAdapter()
  {
    return null;
  }
