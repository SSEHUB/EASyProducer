 ...
 *   <li>{@link de.uni_hildesheim.sse.vil.expressions.expressionDsl.Constant#getVersion <em>Version</em>}</li>
 * </ul>
 *
...
public interface Constant extends EObject
{
   ...
   * @see de.uni_hildesheim.sse.vil.expressions.expressionDsl.ExpressionDslPackage#getConstant_Version()
   * @model
   * @generated
   */
  String getVersion();
  ...
  /**
   * Sets the value of the '{@link de.uni_hildesheim.sse.vil.expressions.expressionDsl.Constant#getVersion <em>Version</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
