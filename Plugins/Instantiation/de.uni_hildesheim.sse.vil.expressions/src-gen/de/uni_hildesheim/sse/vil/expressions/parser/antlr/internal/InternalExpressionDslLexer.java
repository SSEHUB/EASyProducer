...
public class InternalExpressionDslLexer extends Lexer {
    ...
    public final void mRULE_VERSION() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3275:14: ( 'v' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )* )
            // InternalExpressionDsl.g:3275:16: 'v' ( '0' .. '9' )+ ( '.' ( '0' .. '9' )+ )*
            {
            match('v'); 
            // InternalExpressionDsl.g:3275:20: ( '0' .. '9' )+
            int cnt1=0;
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalExpressionDsl.g:3275:21: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
            ...
            // InternalExpressionDsl.g:3275:32: ( '.' ( '0' .. '9' )+ )*
            loop3:
            do {
                int alt3=2;
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalExpressionDsl.g:3275:33: '.' ( '0' .. '9' )+
            	    {
            	    match('.'); 
            	    // InternalExpressionDsl.g:3275:37: ( '0' .. '9' )+
            	    int cnt2=0;
            	    loop2:
            	    do {
            	        int alt2=2;
            	        ...
            	        switch (alt2) {
            	    	case 1 :
            	    	    // InternalExpressionDsl.g:3275:38: '0' .. '9'
            	    	    {
            	    	    matchRange('0','9'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3277:9: ( ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalExpressionDsl.g:3277:11: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '$' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            ...
            // InternalExpressionDsl.g:3277:39: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop4:
            do {
                int alt4=2;
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3279:13: ( ( '-' )? ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* ( RULE_EXPONENT )? )? | '.' ( '0' .. '9' )+ ( RULE_EXPONENT )? | ( '0' .. '9' )+ RULE_EXPONENT ) )
            // InternalExpressionDsl.g:3279:15: ( '-' )? ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* ( RULE_EXPONENT )? )? | '.' ( '0' .. '9' )+ ( RULE_EXPONENT )? | ( '0' .. '9' )+ RULE_EXPONENT )
            {
            // InternalExpressionDsl.g:3279:15: ( '-' )?
            int alt5=2;
            ...
            // InternalExpressionDsl.g:3279:20: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* ( RULE_EXPONENT )? )? | '.' ( '0' .. '9' )+ ( RULE_EXPONENT )? | ( '0' .. '9' )+ RULE_EXPONENT )
            int alt13=3;
            alt13 = dfa13.predict(input);
            switch (alt13) {
                case 1 :
                    // InternalExpressionDsl.g:3279:21: ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* ( RULE_EXPONENT )? )?
                    {
                    // InternalExpressionDsl.g:3279:21: ( '0' .. '9' )+
                    int cnt6=0;
                    loop6:
                    do {
                        int alt6=2;
                        ...
                        switch (alt6) {
                    	case 1 :
                    	    // InternalExpressionDsl.g:3279:22: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    // InternalExpressionDsl.g:3279:33: ( '.' ( '0' .. '9' )* ( RULE_EXPONENT )? )?
                    int alt9=2;
                    ...
                    switch (alt9) {
                        case 1 :
                            // InternalExpressionDsl.g:3279:34: '.' ( '0' .. '9' )* ( RULE_EXPONENT )?
                            {
                            match('.'); 
                            // InternalExpressionDsl.g:3279:38: ( '0' .. '9' )*
                            loop7:
                            do {
                                int alt7=2;
                                ...
                                switch (alt7) {
                            	case 1 :
                            	    // InternalExpressionDsl.g:3279:39: '0' .. '9'
                            	    {
                            	    matchRange('0','9'); 
                            ...
                            // InternalExpressionDsl.g:3279:50: ( RULE_EXPONENT )?
                            int alt8=2;
                    ...
                    break;
                case 2 :
                    // InternalExpressionDsl.g:3279:67: '.' ( '0' .. '9' )+ ( RULE_EXPONENT )?
                    {
                    match('.'); 
                    // InternalExpressionDsl.g:3279:71: ( '0' .. '9' )+
                    int cnt10=0;
                    loop10:
                    do {
                        int alt10=2;
                        ...
                        switch (alt10) {
                    	case 1 :
                    	    // InternalExpressionDsl.g:3279:72: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    // InternalExpressionDsl.g:3279:83: ( RULE_EXPONENT )?
                    int alt11=2;
                    ...
                    break;
                case 3 :
                    // InternalExpressionDsl.g:3279:98: ( '0' .. '9' )+ RULE_EXPONENT
                    {
                    // InternalExpressionDsl.g:3279:98: ( '0' .. '9' )+
                    int cnt12=0;
                    loop12:
                    do {
                        int alt12=2;
                        ...
                        switch (alt12) {
                    	case 1 :
                    	    // InternalExpressionDsl.g:3279:99: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_EXPONENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3281:15: ( ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+ )
            // InternalExpressionDsl.g:3281:17: ( 'e' | 'E' ) ( '+' | '-' )? ( '0' .. '9' )+
            {
            ...
            // InternalExpressionDsl.g:3281:27: ( '+' | '-' )?
            int alt14=2;
            ...
            // InternalExpressionDsl.g:3281:38: ( '0' .. '9' )+
            int cnt15=0;
            loop15:
            do {
                int alt15=2;
                ...
                switch (alt15) {
            	case 1 :
            	    // InternalExpressionDsl.g:3281:39: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3283:13: ( ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalExpressionDsl.g:3283:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalExpressionDsl.g:3283:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalExpressionDsl.g:3283:16: '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalExpressionDsl.g:3283:20: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop16:
                    do {
                        int alt16=3;
                        ...
                        switch (alt16) {
                    	case 1 :
                    	    // InternalExpressionDsl.g:3283:21: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalExpressionDsl.g:3283:66: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalExpressionDsl.g:3283:86: '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalExpressionDsl.g:3283:91: ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' ) | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop17:
                    do {
                        int alt17=3;
                        ...
                        switch (alt17) {
                    	case 1 :
                    	    // InternalExpressionDsl.g:3283:92: '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | 'u' | '\"' | '\\'' | '\\\\' )
                    	    {
                    	    match('\\'); 
                    	    if ( input.LA(1)=='\"'||input.LA(1)=='\''||input.LA(1)=='\\'||input.LA(1)=='b'||input.LA(1)=='f'||input.LA(1)=='n'||input.LA(1)=='r'||(input.LA(1)>='t' && input.LA(1)<='u') ) {
                    	        input.consume();
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalExpressionDsl.g:3283:137: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3285:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalExpressionDsl.g:3285:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalExpressionDsl.g:3285:24: ( options {greedy=false; } : . )*
            loop19:
            do {
                int alt19=2;
                ...
                switch (alt19) {
            	case 1 :
            	    // InternalExpressionDsl.g:3285:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3287:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalExpressionDsl.g:3287:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalExpressionDsl.g:3287:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop20:
            do {
                int alt20=2;
            ...
            // InternalExpressionDsl.g:3287:40: ( ( '\\r' )? '\\n' )?
            int alt22=2;
            ...
            switch (alt22) {
                case 1 :
                    // InternalExpressionDsl.g:3287:41: ( '\\r' )? '\\n'
                    {
                    // InternalExpressionDsl.g:3287:41: ( '\\r' )?
                    int alt21=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3289:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalExpressionDsl.g:3289:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalExpressionDsl.g:3289:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt23=0;
            loop23:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalExpressionDsl.g:3291:16: ( . )
            // InternalExpressionDsl.g:3291:18: .
            {
            matchAny(); 
    ...
    class DFA13 extends DFA {
        ...
        public String getDescription() {
            return "3279:20: ( ( '0' .. '9' )+ ( '.' ( '0' .. '9' )* ( RULE_EXPONENT )? )? | '.' ( '0' .. '9' )+ ( RULE_EXPONENT )? | ( '0' .. '9' )+ RULE_EXPONENT )";
        }
    }
