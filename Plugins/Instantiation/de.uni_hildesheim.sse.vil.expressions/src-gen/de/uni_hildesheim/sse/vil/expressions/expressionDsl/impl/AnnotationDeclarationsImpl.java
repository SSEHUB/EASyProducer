 ...
 * </p>
 * <ul>
 *   <li>{@link de.uni_hildesheim.sse.vil.expressions.expressionDsl.impl.AnnotationDeclarationsImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AnnotationDeclarationsImpl extends MinimalEObjectImpl.Container implements AnnotationDeclarations
{
  ...
  {
    return ExpressionDslPackage.Literals.ANNOTATION_DECLARATIONS;
  }
  ...
  public EList<String> getId()
  {
    if (id == null)
    {
      id = new EDataTypeEList<String>(String.class, this, ExpressionDslPackage.ANNOTATION_DECLARATIONS__ID);
    }
    return id;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ExpressionDslPackage.ANNOTATION_DECLARATIONS__ID:
        return getId();
    }
