...
/**
 * A variable declaration for testing.
 * 
 * @author Holger Eichelberger
 */
class VarDecl extends VariableDeclaration {
     ...
     */
    public VarDecl(String name, TypeDescriptor<?> type) {
        super(name, type);
    }
     ...
     */
    public VarDecl(String name, TypeDescriptor<?> type, boolean isConstant, 
