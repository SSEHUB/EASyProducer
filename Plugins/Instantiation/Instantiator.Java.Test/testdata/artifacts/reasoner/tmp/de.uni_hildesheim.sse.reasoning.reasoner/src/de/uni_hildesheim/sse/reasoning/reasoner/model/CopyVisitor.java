...
/** 
 * Copies a constraint syntax tree possibly mapping the variables. May be  reused after calling   {@link #clear()}
...
public class CopyVisitor implements IConstraintTreeVisitor {
    ...
    * @param mapping a mapping from old variable declarations to new compound access declarations,existing variable declarations are taken over if no mapping is given, may be <b>null</b> in case of no mapping at all
    */
    ...
    * Creates a copy visitor with explicit mapping.
    * @param mapping a mapping from old variable declarations to new compound access declarations,existing variable declarations are taken over if no mapping is given, may be <b>null</b> in case of no mapping at all
    * @param mappingCA a mapping from old variable declarations to new compound access declarations,existing variable declarations are taken over if no mapping is given, may be <b>null</b> in case of no mapping at all
    */
    public CopyVisitor(Map<AbstractVariable, AbstractVariable> mapping,
