...
public class Make extends AbstractFileInstantiator {
     ...
     * @throws ArtifactException in case of execution/parameter problems
     */
    @OperationMeta(returnGenerics = FileArtifact.class)
    public static Set<FileArtifact> make(Path root, String buildFilePath, String buildtarget, 
        Map<String, Object> arguments) throws ArtifactException {
        ...
        if (buildFile.exists() && buildFile.isDirectory()) {
            ...
            throw new ArtifactException("invalid build path", ArtifactException.ID_INSUFFICIENT_ARGUMENT);
        }
        ...
        if (CONSOLE_LOGGER.getMessages().containsKey(ERR_PRIO))  {
            throw new ArtifactException("MAKE: " + CONSOLE_LOGGER.getMessages().get(MSG_PRIO) 
