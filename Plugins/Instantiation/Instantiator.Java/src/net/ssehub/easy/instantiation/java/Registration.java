...
import net.ssehub.easy.instantiation.java.codeArtifacts.JavaCodeSwitch.JavaCodeCaseBlock;
...
public class Registration implements IRegistration {
    ...
    private static void registerJavaCodeTypes() {
        ...
        TypeRegistry.DEFAULT.register(JavaCodeCaseBlock.class);
        ...
        TypeRegistry.DEFAULT.register(JavaCodeArrayInitializerExpression.class);
