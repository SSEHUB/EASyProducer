 ...
 */
class IvmlMetaNameOperationDescriptor extends IvmlMetaOperationDescriptor {
    
    /**
     * The name of the operation.
     */
    public static final String NAME = META_PREFIX + "name";
     ...
     */
    IvmlMetaNameOperationDescriptor(TypeDescriptor<? extends IVilType> declaringType) {
        super(declaringType, TypeRegistry.stringType(), NAME);
    }

    @Override
    protected Object invokeImpl(Object[] args) throws VilException {
        return ((DecisionVariable) args[0]).getName();
    }
