...
public class ScriptContainer extends ModelContainer<Script> {
     ...
     * @param folder The location (folder) of the managed build {@link Script}.
     */
    public ScriptContainer(Script script, File folder) {
        this(script, null, folder);
    }
     ...
     * @param folder The location (folder) of the managed build {@link Script}.
     */
    public ScriptContainer(Script project, SemanticErrorDescription description, File folder) {
        super(project, description, BuildModel.INSTANCE, folder);
    }
