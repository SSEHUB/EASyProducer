...
public class ExpressionVersionRestriction extends 
    de.uni_hildesheim.sse.easy_producer.instantiator.model.expressions.ExpressionVersionRestriction {
    ...
    public IVersionRestriction copy(IModel model) throws RestrictionEvaluationException {
        try {
            ...
            de.uni_hildesheim.sse.easy_producer.instantiator.model.buildlangModel.VariableDeclaration decl = 
                new de.uni_hildesheim.sse.easy_producer.instantiator.model.buildlangModel.VariableDeclaration(
