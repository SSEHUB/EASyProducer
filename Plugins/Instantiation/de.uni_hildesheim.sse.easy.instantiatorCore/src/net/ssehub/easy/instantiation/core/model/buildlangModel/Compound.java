 ...
 */
public class Compound extends net.ssehub.easy.instantiation.core.model.common.Compound implements IBuildlangElement {
     ...
     */
    public Compound(CompoundTypeDescriptor type, Script parent) {
        super(type);
        this.parent = parent;
    }
