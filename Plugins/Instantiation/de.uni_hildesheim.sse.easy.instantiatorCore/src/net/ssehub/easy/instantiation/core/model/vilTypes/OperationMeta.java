...
public @interface OperationMeta {
     ...
     * 
     * @return the operation type ({@link OperationType#NORMAL} by default)
     */
     ...
     * 
     * @return whether artifacts shall be stored
     */
     ...
     * 
     * @return whether dynamic expression processing is required (default <code>false</code>)
     */
